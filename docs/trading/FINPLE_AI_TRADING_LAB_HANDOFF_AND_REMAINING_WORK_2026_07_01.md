...
2. Prepare only the next hash-only recording-result supply gate without reading private paths/raw values/hash inputs, implementing `readOnlyApprovalImport.js`, calling KIS/provider, creating routes/UI/DB, or opening order submission.
