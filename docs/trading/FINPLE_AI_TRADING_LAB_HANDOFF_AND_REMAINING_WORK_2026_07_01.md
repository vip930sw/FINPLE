...
1. Owner supplies a redacted risk-gate clearance review result outside repo commits.
2. Record a separate risk-gate clearance review result contract only after the owner result exists, without reading private evidence, recording raw risk snapshots, opening dry-run replay, or opening order submission.
3. Keep dry-run replay, shadow-history review, and live-guarded adapter review closed until their ordered result records exist.
