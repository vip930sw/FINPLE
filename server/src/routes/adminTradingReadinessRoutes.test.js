...
test("exposes only admin-guarded read-only trading readiness, shadow status, review, risk, result, and draft endpoints", () => {
  ...
  assert.match(routeText, /router\.get\("\/trading-lab-mock-portfolio-performance-recalculation-core"/);
  assert.match(routeText, /router\.get\("\/trading-lab-mock-trading-run-summary-preflight"/);
  assert.match(routeText, /router\.get\("\/trading-lab-mock-trading-run-summary-review-result"/);
  assert.match(routeText, /router\.get\("\/trading-lab-mock-trading-run-summary-core"/);
  assert.match(routeText, /router\.get\("\/trading-lab-mock-dashboard-cleanup-preflight"/);
  assert.match(routeText, /router\.get\("\/trading-lab-mock-dashboard-cleanup-review-result"/);
  assert.match(routeText, /router\.get\("\/trading-lab-mock-dashboard-cleanup-core"/);
