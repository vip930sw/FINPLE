...
import {
  ...
  buildTradingLabMockPortfolioPerformanceRecalculationCoreReviewResult,
  buildTradingLabMockPortfolioPerformanceRecalculationCoreReviewResultRecordingGate,
  ...
  buildTradingLabMockPortfolioPerformanceRecalculationReviewResultRecordingGate,
  buildTradingLabMockPerformanceCoreInputBundle,
  buildTradingLabMockPerformanceCorePolicyReviewSummary,
  buildTradingLabMockPerformanceCoreReviewDecisionSummary,
  buildTradingLabMockPerformanceCoreScenario,
  calculateTradingLabMockPortfolioPerformanceResult,
  buildTradingLabMockTradingRunSummaryInputBundle,
  buildTradingLabMockTradingRunSummaryPreflight,
  buildTradingLabMockDashboardCleanupPreflight,
  buildTradingLabMockDashboardSectionInventory,
  buildTradingLabMockDashboardPriorityLayout,
  buildTradingLabMockDashboardCollapsibleSectionPlan,
  buildTradingLabMockDashboardCleanupReviewResult,
  buildTradingLabMockDashboardCleanupReviewResultRecordingGate,
  buildTradingLabMockDashboardCleanupReviewSectionSummary,
  buildTradingLabMockDashboardCleanupReviewDecisionSummary,
  buildTradingLabMockDashboardCleanupCore,
  buildTradingLabMockDashboardSummaryFirstLayoutResult,
  buildTradingLabMockDashboardCollapsibleDetailGroupResult,
  buildTradingLabMockDashboardCleanupCoreReviewResult,
  buildTradingLabMockDashboardCleanupCoreReviewSummary,
  buildTradingLabDashboardUxPolishPreflightResult,
  buildTradingLabDashboardUxPolishReviewResult,
  buildTradingLabDashboardUxPolishReviewResultRecordingGate,
  buildTradingLabDashboardUxPolishReviewReceipt,
  buildTradingLabDashboardUxPolishReviewDecisionSummary,
  buildTradingLabDashboardUxPolishCoreResult,
  buildTradingLabDashboardUxPolishSummaryFirstLayoutResult,
  buildTradingLabDashboardUxPolishCollapsibleDetailChainResult,
  buildTradingLabDashboardUxPolishKoreanLabelResult,
  buildTradingLabDashboardUxPolishSafetyNoticeResult,
  buildTradingLabDashboardUxPolishReadabilityResult,
  buildTradingLabDashboardUxPolishDuplicateVerboseCleanupResult,
  buildTradingLabDashboardUxPolishTargetInventory,
  buildTradingLabDashboardUxPolishDuplicateVerboseDetection,
  buildTradingLabDashboardKoreanLabelPolishInventory,
  buildTradingLabMockTradingRunSummaryCore,
  buildTradingLabMockTradingRunDashboardAggregationResult,
  buildTradingLabMockTradingRunChartAggregationResult,
  buildTradingLabMockTradingRunSummaryReviewResult,
  buildTradingLabMockPerformanceRecalculationReviewSummary,
  buildTradingLabMockPerformanceRecalculationReviewDecisionSummary,
  buildTradingLabMockPortfolioLedgerUpdateCoreReviewResult,
  buildTradingLabMockPortfolioLedgerUpdateCoreReviewResultRecordingGate,
  buildTradingLabMockPortfolioLedgerUpdateReviewResult,
  buildTradingLabMockPortfolioLedgerUpdateReviewResultRecordingGate,
  buildTradingLabMockLedgerCoreInputBundle,
  buildTradingLabMockPerformanceRecalculationInputBundle,
  buildTradingLabMockPerformanceRecalculationScenario,
  buildTradingLabMockLedgerUpdateCandidates,
  buildTradingLabMockLedgerUpdateScenario,
  buildTradingLabMockLedgerUpdateCorePolicyReviewSummary,
  buildTradingLabMockLedgerUpdateCoreReviewDecisionSummary,
  calculateTradingLabMockPortfolioLedgerUpdateResult,
  buildTradingLabMockLedgerUpdateImpactReviewSummary,
  buildTradingLabMockLedgerUpdateReviewDecisionSummary,
  ...
  validateTradingLabMockPortfolioLedgerUpdateCorePreflight,
  validateTradingLabMockPortfolioLedgerUpdateCore,
  validateTradingLabMockPortfolioPerformanceRecalculationCore,
  validateTradingLabMockTradingRunSummaryPreflight,
  validateTradingLabMockDashboardCleanupPreflight,
  validateTradingLabMockDashboardCleanupReviewResult,
  validateTradingLabMockDashboardCleanupCore,
  validateTradingLabMockDashboardCleanupCoreReviewResult,
  validateTradingLabDashboardUxPolishPreflight,
  validateTradingLabDashboardUxPolishReviewResult,
  validateTradingLabDashboardUxPolishCore,
  validateTradingLabMockTradingRunSummaryCore,
  validateTradingLabMockTradingRunSummaryReviewResult,
  validateTradingLabMockPortfolioPerformanceRecalculationCoreReviewResult,
  validateTradingLabMockPortfolioPerformanceRecalculationCorePreflight,
  validateTradingLabMockPortfolioPerformanceRecalculationPreflight,
  validateTradingLabMockPortfolioPerformanceRecalculationReviewResult,
  validateTradingLabMockPortfolioLedgerUpdateCoreReviewResult,
  validateTradingLabMockPortfolioLedgerUpdateReviewResult,
  validateTradingLabMockCashLedgerUpdatePolicy,
  validateTradingLabMockLedgerConsistencyReadiness,
  validateTradingLabMockLedgerDeterministicUpdateReadiness,
  validateTradingLabMockPnlPlaceholderPolicy,
  validateTradingLabMockPortfolioValuationPolicy,
  validateTradingLabMockPositionLedgerUpdatePolicy,
...
test("Step 136 admin review result status and dashboard integration remain admin-only fail-closed", () => {
  ...
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.strategyDraftReviewStatus.step, "Step 135: Admin trading lab strategy draft comparison review gate");
...
test("Step 150 mock portfolio ledger update review result records redacted receipt without ledger mutation", () => {
  const mockPortfolioLedgerUpdatePreflightStatus = buildAdminTradingLabMockPortfolioLedgerUpdatePreflightStatus();
  const validation = validateTradingLabMockPortfolioLedgerUpdateReviewResult({ mockPortfolioLedgerUpdatePreflightStatus });
  const reviewResult = buildTradingLabMockPortfolioLedgerUpdateReviewResult({ mockPortfolioLedgerUpdatePreflightStatus, validation });
  const recordingGate = buildTradingLabMockPortfolioLedgerUpdateReviewResultRecordingGate({ mockPortfolioLedgerUpdatePreflightStatus, validation, reviewResult });
  const impactReviewSummary = buildTradingLabMockLedgerUpdateImpactReviewSummary({ mockPortfolioLedgerUpdatePreflightStatus });
  const decisionSummary = buildTradingLabMockLedgerUpdateReviewDecisionSummary({ mockPortfolioLedgerUpdatePreflightStatus, validation });
  const serialized = JSON.stringify({ validation, reviewResult, recordingGate, impactReviewSummary, decisionSummary });

  assert.equal(validation.redacted, true);
  assert.equal(recordingGate.status, "admin_only_trading_lab_mock_portfolio_ledger_update_review_result_fail_closed");
  assert.equal(recordingGate.receipt.redacted, true);
  assert.equal(recordingGate.receipt.nextAllowedStep, "mock_portfolio_ledger_update_core_preflight");
  assert.equal(reviewResult.reviewStatus, validation.status);
  assert.equal(impactReviewSummary.redacted, true);
  assert.equal(decisionSummary.redacted, true);
  assert.equal(recordingGate.boundaries.adminOnly, true);
  assert.equal(recordingGate.boundaries.publicDashboardExposed, false);
  assert.equal(recordingGate.boundaries.myPageDashboardExposed, false);
  assert.equal(recordingGate.boundaries.homepageDashboardExposed, false);
  assert.equal(recordingGate.providerCallsAllowed, false);
  assert.equal(recordingGate.orderSubmissionAllowed, false);
  assert.equal(recordingGate.readyForReadOnlyProviderCalls, false);
  assert.equal(recordingGate.readyForOrderSubmission, false);
  assert.equal(recordingGate.readyForLiveGuardedTrading, false);
  assert.equal(recordingGate.actualLedgerEntryCreated, false);
  assert.equal(recordingGate.actualPortfolioLedgerUpdated, false);
  assert.equal(recordingGate.actualCashUpdated, false);
  assert.equal(recordingGate.actualPositionUpdated, false);
  assert.equal(recordingGate.accountBalanceQueried, false);
  assert.equal(recordingGate.persistentStorageUsed, false);
  ...
  assert.equal(serialized.includes("actualExecutionId"), false);
  assert.equal(serialized.includes("actualFillId"), false);
  assert.equal(serialized.includes("actualAccountBalance"), false);
});

test("Step 150 mock portfolio ledger update review result blocks missing unsafe or negative Step149 dependencies", () => {
  const missingValidation = validateTradingLabMockPortfolioLedgerUpdateReviewResult({
    mockPortfolioLedgerUpdatePreflightStatus: null,
  });
  const unsafeValidation = validateTradingLabMockPortfolioLedgerUpdateReviewResult({
    mockPortfolioLedgerUpdatePreflightStatus: {
      status: "admin_only_trading_lab_mock_portfolio_ledger_update_preflight_fail_closed",
      result: {
        ledgerUpdatePreflightId: "unsafe_preflight",
        status: "mock_ledger_update_ready",
        scope: "live",
        redacted: false,
        readinessImpact: "ready",
        providerCallImpact: "allowed",
        orderSubmissionImpact: "allowed",
        liveTradingImpact: "ready",
        nextAllowedStep: "actual_ledger_update",
      },
      validation: { status: "mock_ledger_update_ready" },
      ledgerUpdateCandidates: [
        {
          ledgerUpdateCandidateId: "unsafe_candidate",
          scope: "live",
          redacted: false,
          cashAfterPreview: -1,
          positionAfterPreview: -1,
          portfolioValueAfterPreview: -1,
  ...
  const negativePreflight = buildTradingLabMockPortfolioLedgerUpdatePreflight({
    mockFillSimulationCoreStatus: buildAdminTradingLabMockFillSimulationCoreStatus(),
    ledgerUpdateCandidates: [
      {
        ledgerUpdateCandidateId: "negative_cash_candidate",
        sourceStep: "step149",
        mockFillResultId: "fill",
        mockRunCandidateId: "run",
        strategyDraftId: "strategy",
        scope: "mock_only",
        status: "validation_required",
        redacted: true,
        cashAfterPreview: -10,
        positionAfterPreview: 1,
        portfolioValueAfterPreview: 100,
  ...
  const negativeValidation = validateTradingLabMockPortfolioLedgerUpdateReviewResult({
    mockPortfolioLedgerUpdatePreflightStatus: negativePreflight,
  });

  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_preflight_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_portfolio_ledger_update_preflight_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_portfolio_ledger_update_preflight_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("actual_ledger_entry_must_not_be_created"));
  assert.ok(unsafeValidation.blockers.includes("actual_portfolio_ledger_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("persistent_db_write_must_not_run"));
  assert.equal(negativeValidation.status, "validation_required");
  assert.ok(negativeValidation.warnings.includes("cash_after_preview_negative"));
  assert.equal(negativeValidation.providerCallsAllowed, false);
  assert.equal(negativeValidation.orderSubmissionAllowed, false);
  assert.equal(negativeValidation.readyForLiveGuardedTrading, false);
});

test("Step 150 admin mock portfolio ledger update review result status and dashboard integration remain admin-only fail-closed", () => {
  const mockPortfolioLedgerUpdateReviewResultStatus = buildAdminTradingLabMockPortfolioLedgerUpdateReviewResultStatus();
  const dashboard = buildAdminTradingLabDashboardStatus();
  const serialized = JSON.stringify({ mockPortfolioLedgerUpdateReviewResultStatus, dashboard });

  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.status, "admin_only_trading_lab_mock_portfolio_ledger_update_review_result_fail_closed");
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.boundaries.adminOnly, true);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.boundaries.publicDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.boundaries.myPageDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.boundaries.homepageDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.actualLedgerEntryCreated, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.actualPortfolioLedgerUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.actualCashUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.actualPositionUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.accountBalanceQueried, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.providerCallsAllowed, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.orderSubmissionAllowed, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.readyForReadOnlyProviderCalls, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.readyForOrderSubmission, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.readyForLiveGuardedTrading, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.persistentStorageUsed, false);
  assert.equal(mockPortfolioLedgerUpdateReviewResultStatus.dbWriteUsed, false);
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.mockPortfolioLedgerUpdatePreflightStatus.step, "Step 149: Admin trading lab mock portfolio ledger update preflight");
  assert.equal(dashboard.mockPortfolioLedgerUpdateReviewResultStatus.step, "Step 150: Admin trading lab mock portfolio ledger update review result recording gate");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
...
test("Step 151 mock portfolio ledger update core preflight builds redacted deterministic input bundle without ledger mutation", () => {
  const mockPortfolioLedgerUpdateReviewResultStatus = buildAdminTradingLabMockPortfolioLedgerUpdateReviewResultStatus();
  const ledgerCoreInputBundle = buildTradingLabMockLedgerCoreInputBundle({ mockPortfolioLedgerUpdateReviewResultStatus });
  const ledgerUpdateScenario = buildTradingLabMockLedgerUpdateScenario({ ledgerCoreInputBundle });
  const cashLedgerPolicyValidation = validateTradingLabMockCashLedgerUpdatePolicy({ ledgerCoreInputBundle });
  const positionLedgerPolicyValidation = validateTradingLabMockPositionLedgerUpdatePolicy({ ledgerCoreInputBundle });
  const valuationPolicyValidation = validateTradingLabMockPortfolioValuationPolicy({ ledgerCoreInputBundle });
  const pnlPlaceholderPolicyValidation = validateTradingLabMockPnlPlaceholderPolicy({ ledgerCoreInputBundle });
  const ledgerConsistencyReadiness = validateTradingLabMockLedgerConsistencyReadiness({ ledgerCoreInputBundle, ledgerUpdateScenario });
  const deterministicUpdateReadiness = validateTradingLabMockLedgerDeterministicUpdateReadiness({ ledgerCoreInputBundle, ledgerUpdateScenario });
  const validation = validateTradingLabMockPortfolioLedgerUpdateCorePreflight({
  ...
  const preflight = buildTradingLabMockPortfolioLedgerUpdateCorePreflight({
    mockPortfolioLedgerUpdateReviewResultStatus,
    ledgerCoreInputBundle,
    ledgerUpdateScenario,
    validation,
  });
  const serialized = JSON.stringify({ ledgerCoreInputBundle, ledgerUpdateScenario, validation, preflight });

  assert.equal(ledgerCoreInputBundle.redacted, true);
  assert.equal(ledgerCoreInputBundle.scope, "mock_only");
  assert.equal(ledgerUpdateScenario.redacted, true);
  assert.equal(ledgerUpdateScenario.scope, "mock_only");
  assert.equal(ledgerUpdateScenario.persistentDbWritePolicy, "blocked");
  assert.equal(ledgerUpdateScenario.actualLedgerUpdatePolicy, "blocked");
  assert.equal(cashLedgerPolicyValidation.actualCashUpdated, false);
  assert.equal(positionLedgerPolicyValidation.actualPositionUpdated, false);
  assert.equal(valuationPolicyValidation.providerCallsAllowed, false);
  assert.equal(pnlPlaceholderPolicyValidation.actualLedgerEntryCreated, false);
  assert.equal(ledgerConsistencyReadiness.actualPortfolioLedgerUpdated, false);
  assert.equal(deterministicUpdateReadiness.providerCallsAllowed, false);
  assert.equal(preflight.status, "admin_only_trading_lab_mock_portfolio_ledger_update_core_preflight_fail_closed");
  assert.equal(preflight.result.redacted, true);
  assert.equal(preflight.result.scope, "mock_only");
  assert.equal(preflight.result.nextAllowedStep, "mock_portfolio_ledger_update_core");
  assert.equal(preflight.boundaries.adminOnly, true);
  assert.equal(preflight.boundaries.publicDashboardExposed, false);
  assert.equal(preflight.boundaries.myPageDashboardExposed, false);
  assert.equal(preflight.boundaries.homepageDashboardExposed, false);
  assert.equal(preflight.boundaries.actualLedgerUpdateAllowed, false);
  assert.equal(preflight.boundaries.actualCashUpdateAllowed, false);
  assert.equal(preflight.boundaries.actualPositionUpdateAllowed, false);
  assert.equal(preflight.boundaries.accountBalanceQueryAllowed, false);
  assert.equal(preflight.providerCallsAllowed, false);
  assert.equal(preflight.orderSubmissionAllowed, false);
  assert.equal(preflight.readyForReadOnlyProviderCalls, false);
  assert.equal(preflight.readyForOrderSubmission, false);
  assert.equal(preflight.readyForLiveGuardedTrading, false);
  assert.equal(preflight.actualLedgerEntryCreated, false);
  assert.equal(preflight.actualPortfolioLedgerUpdated, false);
  assert.equal(preflight.actualCashUpdated, false);
  assert.equal(preflight.actualPositionUpdated, false);
  assert.equal(preflight.accountBalanceQueried, false);
  assert.equal(preflight.persistentStorageUsed, false);
  assert.equal(preflight.dbWriteUsed, false);
  assert.equal(serialized.includes("APP_KEY"), false);
  assert.equal(serialized.includes("APP_SECRET"), false);
...
test("Step 151 mock portfolio ledger update core preflight blocks missing unsafe or invalid Step150 dependencies", () => {
  const missingValidation = validateTradingLabMockPortfolioLedgerUpdateCorePreflight({
    mockPortfolioLedgerUpdateReviewResultStatus: null,
  });
  const unsafeValidation = validateTradingLabMockPortfolioLedgerUpdateCorePreflight({
    mockPortfolioLedgerUpdateReviewResultStatus: {
      status: "admin_only_trading_lab_mock_portfolio_ledger_update_review_result_fail_closed",
      reviewResult: {
        ledgerUpdateReviewResultId: "unsafe_review",
        reviewStatus: "recorded",
        redacted: false,
        readinessImpact: "ready",
        providerCallImpact: "allowed",
    ...
    ledgerCoreInputBundle: {
      ledgerCoreInputBundleId: "unsafe_bundle",
      scope: "live",
      redacted: false,
      cashAfterPreview: -10,
      positionAfterPreview: -1,
      portfolioValueAfterPreview: -1,
      mockValuationPolicy: "provider_quote",
    ...
    ledgerUpdateScenario: {
      ledgerUpdateScenarioId: "unsafe_scenario",
      scope: "live",
      redacted: false,
      deterministic: false,
      persistentDbWritePolicy: "allowed",
      actualLedgerUpdatePolicy: "allowed",
      deterministicUpdatePolicy: "live_mutation",
    },
  });
  const validationRequired = validateTradingLabMockPortfolioLedgerUpdateCorePreflight({
    ledgerCoreInputBundle: {
      ...buildTradingLabMockLedgerCoreInputBundle(),
      cashAfterPreview: -10,
      positionAfterPreview: -1,
  ...
  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_review_result_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_review_result_missing"));
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_review_receipt_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_portfolio_ledger_update_review_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_portfolio_ledger_update_review_receipt_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("review_result_provider_call_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("review_result_next_step_not_ledger_update_core_preflight"));
  assert.ok(unsafeValidation.blockers.includes("mock_ledger_update_core_payload_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_ledger_update_core_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("actual_ledger_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_cash_or_position_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_account_balance_query_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("persistent_db_write_must_not_run"));
  assert.equal(validationRequired.status, "validation_required");
  assert.ok(validationRequired.warnings.some((warning) => warning.includes("validation_required")));
  assert.equal(validationRequired.providerCallsAllowed, false);
  assert.equal(validationRequired.orderSubmissionAllowed, false);
  assert.equal(validationRequired.readyForLiveGuardedTrading, false);
});

test("Step 151 admin mock portfolio ledger update core preflight status and dashboard integration remain admin-only fail-closed", () => {
  const mockPortfolioLedgerUpdateCorePreflightStatus = buildAdminTradingLabMockPortfolioLedgerUpdateCorePreflightStatus();
  const dashboard = buildAdminTradingLabDashboardStatus();
  const serialized = JSON.stringify({ mockPortfolioLedgerUpdateCorePreflightStatus, dashboard });

  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.status, "admin_only_trading_lab_mock_portfolio_ledger_update_core_preflight_fail_closed");
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.step, "Step 151: Admin trading lab mock portfolio ledger update core preflight");
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.boundaries.adminOnly, true);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.boundaries.publicDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.boundaries.myPageDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.boundaries.homepageDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.actualLedgerEntryCreated, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.actualPortfolioLedgerUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.actualCashUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.actualPositionUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.accountBalanceQueried, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.providerCallsAllowed, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.orderSubmissionAllowed, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.readyForReadOnlyProviderCalls, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.readyForOrderSubmission, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.readyForLiveGuardedTrading, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.persistentStorageUsed, false);
  assert.equal(mockPortfolioLedgerUpdateCorePreflightStatus.dbWriteUsed, false);
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.mockPortfolioLedgerUpdateReviewResultStatus.step, "Step 150: Admin trading lab mock portfolio ledger update review result recording gate");
  assert.equal(dashboard.mockPortfolioLedgerUpdateCorePreflightStatus.step, "Step 151: Admin trading lab mock portfolio ledger update core preflight");
  assert.equal(dashboard.mockPortfolioLedgerUpdateCorePreflightModel.sourceStep, "step151");
  assert.equal(dashboard.mockLedgerCoreInputBundleModel.scope, "mock_only");
  assert.equal(dashboard.mockLedgerUpdateScenarioModel.scope, "mock_only");
  assert.equal(dashboard.mockLedgerUpdateCorePreflightResultSchema.nextAllowedStep, "mock_portfolio_ledger_update_core");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
...
test("Step 152 mock portfolio ledger update core review result records redacted receipt without ledger mutation", () => {
  const mockPortfolioLedgerUpdateCorePreflightStatus = buildAdminTradingLabMockPortfolioLedgerUpdateCorePreflightStatus();
  const validation = validateTradingLabMockPortfolioLedgerUpdateCoreReviewResult({ mockPortfolioLedgerUpdateCorePreflightStatus });
  const reviewResult = buildTradingLabMockPortfolioLedgerUpdateCoreReviewResult({ mockPortfolioLedgerUpdateCorePreflightStatus, validation });
  const recordingGate = buildTradingLabMockPortfolioLedgerUpdateCoreReviewResultRecordingGate({ mockPortfolioLedgerUpdateCorePreflightStatus, validation, reviewResult });
  const policyReviewSummary = buildTradingLabMockLedgerUpdateCorePolicyReviewSummary({ mockPortfolioLedgerUpdateCorePreflightStatus });
  const decisionSummary = buildTradingLabMockLedgerUpdateCoreReviewDecisionSummary({ mockPortfolioLedgerUpdateCorePreflightStatus, validation });
  const serialized = JSON.stringify({ validation, reviewResult, recordingGate, policyReviewSummary, decisionSummary });

  assert.equal(validation.redacted, true);
  assert.equal(recordingGate.status, "admin_only_trading_lab_mock_portfolio_ledger_update_core_review_result_fail_closed");
  assert.equal(recordingGate.receipt.redacted, true);
  assert.equal(recordingGate.receipt.nextAllowedStep, "mock_portfolio_ledger_update_core");
  assert.equal(reviewResult.reviewStatus, validation.status);
  assert.equal(policyReviewSummary.redacted, true);
  assert.equal(decisionSummary.redacted, true);
  assert.equal(recordingGate.boundaries.adminOnly, true);
...
test("Step 152 mock portfolio ledger update core review result blocks missing unsafe or invalid Step151 dependencies", () => {
  const missingValidation = validateTradingLabMockPortfolioLedgerUpdateCoreReviewResult({
    mockPortfolioLedgerUpdateCorePreflightStatus: null,
  });
  const unsafeValidation = validateTradingLabMockPortfolioLedgerUpdateCoreReviewResult({
    mockPortfolioLedgerUpdateCorePreflightStatus: {
      ...
      result: {
        ledgerUpdateCorePreflightId: "unsafe_core_preflight",
        ledgerCoreInputBundleId: "unsafe_bundle",
        status: "mock_ledger_update_core_ready",
        scope: "live",
        redacted: false,
        readinessImpact: "ready",
        providerCallImpact: "allowed",
      ...
      validation: {
        status: "mock_ledger_update_core_ready",
        cashLedgerPolicyStatus: "valid",
        positionLedgerPolicyStatus: "valid",
        valuationPolicyStatus: "valid",
        pnlPlaceholderStatus: "placeholder_only",
        ledgerConsistencyStatus: "deterministic",
        deterministicUpdateStatus: "deterministic",
      },
      ledgerCoreInputBundle: {
        ledgerCoreInputBundleId: "unsafe_bundle",
        scope: "live",
  ...
  const validationRequired = validateTradingLabMockPortfolioLedgerUpdateCoreReviewResult({
    mockPortfolioLedgerUpdateCorePreflightStatus: {
      ...buildAdminTradingLabMockPortfolioLedgerUpdateCorePreflightStatus(),
      result: {
        ...buildAdminTradingLabMockPortfolioLedgerUpdateCorePreflightStatus().result,
        status: "validation_required",
        cashAfterPreview: -1,
      },
      validation: {
        ...buildAdminTradingLabMockPortfolioLedgerUpdateCorePreflightStatus().validation,
        status: "validation_required",
        ledgerConsistencyStatus: "validation_required",
      },
      ledgerCoreInputBundle: {
        ...buildTradingLabMockLedgerCoreInputBundle(),
        cashAfterPreview: -1,
  ...
  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_core_preflight_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_core_preflight_result_missing"));
  assert.ok(missingValidation.blockers.includes("mock_ledger_core_input_bundle_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_portfolio_ledger_update_core_preflight_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_portfolio_ledger_update_core_preflight_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("mock_ledger_core_input_bundle_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("actual_ledger_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_cash_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_position_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("persistent_db_write_must_not_run"));
  assert.equal(validationRequired.status, "validation_required");
  assert.ok(validationRequired.warnings.includes("mock_portfolio_ledger_update_core_preflight_validation_required"));
  assert.ok(validationRequired.warnings.includes("mock_cash_after_preview_negative"));
  assert.equal(validationRequired.providerCallsAllowed, false);
  assert.equal(validationRequired.orderSubmissionAllowed, false);
  assert.equal(validationRequired.readyForLiveGuardedTrading, false);
});

test("Step 152 admin mock portfolio ledger update core review result status and dashboard integration remain admin-only fail-closed", () => {
  const mockPortfolioLedgerUpdateCoreReviewResultStatus = buildAdminTradingLabMockPortfolioLedgerUpdateCoreReviewResultStatus();
  const dashboard = buildAdminTradingLabDashboardStatus();
  const serialized = JSON.stringify({ mockPortfolioLedgerUpdateCoreReviewResultStatus, dashboard });

  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.status, "admin_only_trading_lab_mock_portfolio_ledger_update_core_review_result_fail_closed");
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.step, "Step 152: Admin trading lab mock portfolio ledger update core review result recording gate");
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.boundaries.adminOnly, true);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.boundaries.publicDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.boundaries.myPageDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.boundaries.homepageDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.actualLedgerEntryCreated, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.actualPortfolioLedgerUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.actualCashUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.actualPositionUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.accountBalanceQueried, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.providerCallsAllowed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.orderSubmissionAllowed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.readyForReadOnlyProviderCalls, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.readyForOrderSubmission, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.readyForLiveGuardedTrading, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.persistentStorageUsed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreReviewResultStatus.dbWriteUsed, false);
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.mockPortfolioLedgerUpdateCorePreflightStatus.step, "Step 151: Admin trading lab mock portfolio ledger update core preflight");
  assert.equal(dashboard.mockPortfolioLedgerUpdateCoreReviewResultStatus.step, "Step 152: Admin trading lab mock portfolio ledger update core review result recording gate");
  assert.equal(dashboard.mockPortfolioLedgerUpdateCoreReviewResultModel.sourceStep, "step152");
  assert.equal(dashboard.mockLedgerUpdateCoreReviewReceiptSchema.nextAllowedStep, "mock_portfolio_ledger_update_core");
  assert.equal(dashboard.mockLedgerUpdateCoreReviewDecisionSummaryModel.sourceStep, "step152");
  assert.equal(dashboard.mockLedgerUpdateCorePolicyReviewSummaryModel.sourceStep, "step152");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
...
test("Step 153 mock portfolio ledger update core computes deterministic redacted mock results without ledger mutation", () => {
  const reviewStatus = buildAdminTradingLabMockPortfolioLedgerUpdateCoreReviewResultStatus();
  const recordedReviewStatus = {
    ...reviewStatus,
    reviewResult: {
      ...reviewStatus.reviewResult,
      reviewStatus: "recorded",
      decision: "mock_ledger_update_core_review_recorded",
    },
    receipt: {
  ...
  const input = { mockPortfolioLedgerUpdateCoreReviewResultStatus: recordedReviewStatus };
  const validation = validateTradingLabMockPortfolioLedgerUpdateCore(input);
  const calculated = calculateTradingLabMockPortfolioLedgerUpdateResult({ ...input, validation });
  const status = buildTradingLabMockPortfolioLedgerUpdateCore({ validation, ledgerUpdateResult: calculated });
  const secondCalculated = calculateTradingLabMockPortfolioLedgerUpdateResult({ ...input, validation });
  const serialized = JSON.stringify(status);

  assert.equal(validation.status, "mock_ledger_updated");
  assert.equal(calculated.updateStatus, "mock_ledger_updated");
  assert.equal(calculated.cashAfter, calculated.cashBefore + calculated.cashDelta);
  assert.equal(calculated.positionAfter, calculated.positionBefore + calculated.positionDelta);
  assert.equal(calculated.portfolioValueDelta, Number((calculated.portfolioValueAfter - calculated.portfolioValueBefore).toFixed(2)));
  assert.deepEqual(calculated, secondCalculated);
  assert.equal(status.cashLedgerUpdateResult.cashAfter, calculated.cashAfter);
  assert.equal(status.positionLedgerUpdateResult.positionAfter, calculated.positionAfter);
  assert.equal(status.portfolioValueUpdateResult.portfolioValueAfter, calculated.portfolioValueAfter);
  assert.equal(status.pnlPlaceholderResult.pnlStatus, "placeholder_only");
  assert.equal(status.ledgerUpdateResult.redacted, true);
  assert.equal(status.ledgerUpdateResult.scope, "mock_only");
  assert.equal(status.ledgerUpdateResult.readinessImpact, "none");
  assert.equal(status.ledgerUpdateResult.providerCallImpact, "blocked");
  assert.equal(status.ledgerUpdateResult.orderSubmissionImpact, "blocked");
  assert.equal(status.ledgerUpdateResult.liveTradingImpact, "blocked");
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
  assert.equal(status.readyForOrderSubmission, false);
  ...
  assert.equal(serialized.includes("APP_SECRET"), false);
  assert.equal(serialized.includes("accountNumber"), false);
  assert.equal(serialized.includes("containsProviderPayload\":true"), false);
  assert.equal(serialized.includes("containsOrderPayload\":true"), false);
  assert.equal(serialized.includes("containsRawProviderResponse\":true"), false);
  assert.equal(serialized.includes("hashValue\":true"), false);
  assert.equal(serialized.includes("digestValue\":true"), false);
  assert.equal(serialized.includes("kisOrderPayloadCreated\":true"), false);
  assert.equal(serialized.includes("kisExecutionPayloadCreated\":true"), false);
  assert.equal(serialized.includes("kisFillPayloadCreated\":true"), false);
});

test("Step 153 mock portfolio ledger update core blocks missing unsafe and negative dependencies", () => {
  const missingValidation = validateTradingLabMockPortfolioLedgerUpdateCore({
    mockPortfolioLedgerUpdateCoreReviewResultStatus: null,
    mockPortfolioLedgerUpdateCorePreflightStatus: null,
  });
  const unsafeValidation = validateTradingLabMockPortfolioLedgerUpdateCore({
    mockPortfolioLedgerUpdateCoreReviewResultStatus: {
      reviewResult: {
        ...buildAdminTradingLabMockPortfolioLedgerUpdateCoreReviewResultStatus().reviewResult,
        redacted: false,
        reviewStatus: "blocked",
        readinessImpact: "ready",
      },
      receipt: {
        ...buildAdminTradingLabMockPortfolioLedgerUpdateCoreReviewResultStatus().receipt,
        redacted: false,
        nextAllowedStep: "actual_ledger_update",
      },
      validation: {
        ...buildAdminTradingLabMockPortfolioLedgerUpdateCoreReviewResultStatus().validation,
        status: "blocked",
      },
    },
    mockPortfolioLedgerUpdateCorePreflightStatus: {
  ...
  const recordedReviewStatus = buildAdminTradingLabMockPortfolioLedgerUpdateCoreReviewResultStatus();
  const recordedDependency = {
    ...recordedReviewStatus,
    reviewResult: {
      ...recordedReviewStatus.reviewResult,
      reviewStatus: "recorded",
      decision: "mock_ledger_update_core_review_recorded",
    },
    receipt: {
      ...recordedReviewStatus.receipt,
      reviewStatus: "recorded",
      decision: "mock_ledger_update_core_review_recorded",
    },
    validation: {
      ...recordedReviewStatus.validation,
      status: "recorded",
      blockerCount: 0,
      warningCount: 0,
      blockers: [],
  ...
  const negativeValidation = validateTradingLabMockPortfolioLedgerUpdateCore({
    mockPortfolioLedgerUpdateCoreReviewResultStatus: recordedDependency,
    cashBefore: 10,
    cashDelta: -20,
    positionBefore: 1,
    positionDelta: -2,
  });
  const rejectedValidation = validateTradingLabMockPortfolioLedgerUpdateCore({
    side: "mock_buy",
    fillStatus: "mock_rejected",
    cashDelta: -1,
    positionDelta: 1,
  });

  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_core_review_result_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_core_review_result_missing"));
  assert.ok(missingValidation.blockers.includes("mock_ledger_core_input_bundle_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_ledger_update_core_review_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_ledger_core_input_bundle_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_ledger_core_input_bundle_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("actual_ledger_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_cash_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_position_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("persistent_db_write_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("kis_order_execution_fill_payload_must_not_be_created"));
  assert.equal(negativeValidation.status, "validation_required");
  assert.ok(negativeValidation.warnings.includes("mock_cash_after_negative"));
  assert.ok(negativeValidation.warnings.includes("mock_position_after_negative"));
  assert.equal(rejectedValidation.status, "blocked");
  assert.ok(rejectedValidation.blockers.includes("mock_rejected_fill_delta_must_be_zero"));
});

test("Step 153 admin mock portfolio ledger update core status and dashboard integration remain admin-only fail-closed", () => {
  const mockPortfolioLedgerUpdateCoreStatus = buildAdminTradingLabMockPortfolioLedgerUpdateCoreStatus();
  const dashboard = buildAdminTradingLabDashboardStatus();
  const serialized = JSON.stringify({ mockPortfolioLedgerUpdateCoreStatus, dashboard });

  assert.equal(mockPortfolioLedgerUpdateCoreStatus.step, "Step 153: Admin trading lab mock portfolio ledger update core");
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.status, "admin_only_trading_lab_mock_portfolio_ledger_update_core_fail_closed");
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.mockPortfolioLedgerUpdateResultModel.sourceStep, "step153");
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.mockCashLedgerUpdateResultModel.sourceStep, "step153");
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.mockPositionLedgerUpdateResultModel.sourceStep, "step153");
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.mockPortfolioValueUpdateResultModel.sourceStep, "step153");
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.mockPortfolioLedgerUpdateResultSchema.nextAllowedStep, "mock_portfolio_performance_recalculation_preflight");
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.boundaries.adminOnly, true);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.boundaries.publicDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.boundaries.myPageDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.boundaries.homepageDashboardExposed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.actualLedgerEntryCreated, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.actualPortfolioLedgerUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.actualCashUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.actualPositionUpdated, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.accountBalanceQueried, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.persistentStorageUsed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.dbWriteUsed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.providerCallsAllowed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.orderSubmissionAllowed, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.readyForReadOnlyProviderCalls, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.readyForOrderSubmission, false);
  assert.equal(mockPortfolioLedgerUpdateCoreStatus.readyForLiveGuardedTrading, false);
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.mockPortfolioLedgerUpdateCoreStatus.step, "Step 153: Admin trading lab mock portfolio ledger update core");
  assert.equal(dashboard.mockPortfolioLedgerUpdateCoreStatus.ledgerUpdateResult.redacted, true);
  assert.equal(dashboard.mockPortfolioLedgerUpdateResultModel.sourceStep, "step153");
  assert.equal(dashboard.mockCashLedgerUpdateResultModel.sourceStep, "step153");
  assert.equal(dashboard.mockPositionLedgerUpdateResultModel.sourceStep, "step153");
  assert.equal(dashboard.mockPortfolioValueUpdateResultModel.sourceStep, "step153");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
  ...
  assert.equal(serialized.includes("actualPositionUpdated\":true"), false);
  assert.equal(serialized.includes("accountBalanceQueried\":true"), false);
  assert.equal(serialized.includes("persistentStorageUsed\":true"), false);
  assert.equal(serialized.includes("dbWriteUsed\":true"), false);
  assert.equal(serialized.includes("providerCallsAllowed\":true"), false);
  assert.equal(serialized.includes("orderSubmissionAllowed\":true"), false);
  assert.equal(serialized.includes("readyForLiveGuardedTrading\":true"), false);
});

test("Step 154 mock portfolio performance recalculation preflight builds redacted mock-only readiness without performance mutation", () => {
  const preflight = buildTradingLabMockPortfolioPerformanceRecalculationPreflight();
  const bundle = buildTradingLabMockPerformanceRecalculationInputBundle();
  const scenario = buildTradingLabMockPerformanceRecalculationScenario();
  const validation = validateTradingLabMockPortfolioPerformanceRecalculationPreflight({ performanceInputBundle: bundle, performanceScenario: scenario });
  const serialized = JSON.stringify({ preflight, bundle, scenario, validation });

  assert.equal(preflight.step, "Step 154: Admin trading lab mock portfolio performance recalculation preflight");
  assert.equal(preflight.status, "admin_only_trading_lab_mock_portfolio_performance_recalculation_preflight_fail_closed");
  assert.equal(preflight.mockPortfolioPerformanceRecalculationPreflightModel.sourceStep, "step154");
  assert.equal(preflight.mockPerformanceRecalculationInputBundleModel.sourceStep, "step154");
  assert.equal(preflight.mockPerformanceRecalculationScenarioModel.sourceStep, "step154");
  assert.equal(preflight.mockPerformanceRecalculationPreflightResultSchema.nextAllowedStep, "mock_portfolio_performance_recalculation_review_result");
  assert.equal(preflight.result.scope, "mock_only");
  assert.equal(preflight.result.redacted, true);
  assert.equal(preflight.result.status, "mock_performance_recalculation_ready");
  assert.equal(preflight.result.equitySeriesStatus, "ready");
  assert.equal(preflight.result.dailyReturnStatus, "ready");
  assert.equal(preflight.result.cumulativeReturnStatus, "ready");
  assert.equal(preflight.result.drawdownStatus, "ready");
  assert.equal(preflight.result.mddStatus, "ready");
  assert.equal(preflight.result.allocationStatus, "ready");
  assert.equal(preflight.result.realizedPnlStatus, "placeholder_only");
  assert.equal(preflight.result.unrealizedPnlStatus, "placeholder_only");
  assert.equal(preflight.result.kpiSummaryStatus, "ready");
  assert.equal(preflight.result.chartDataStatus, "ready");
  assert.equal(preflight.result.readinessImpact, "none");
  assert.equal(preflight.result.providerCallImpact, "blocked");
  assert.equal(preflight.result.orderSubmissionImpact, "blocked");
  assert.equal(preflight.result.liveTradingImpact, "blocked");
  assert.equal(bundle.scope, "mock_only");
  assert.equal(bundle.redacted, true);
  assert.equal(scenario.scope, "mock_only");
  assert.equal(scenario.redacted, true);
  assert.equal(validation.status, "mock_performance_recalculation_ready");
  assert.equal(preflight.providerCallsAllowed, false);
  assert.equal(preflight.orderSubmissionAllowed, false);
  assert.equal(preflight.readyForReadOnlyProviderCalls, false);
  assert.equal(preflight.readyForOrderSubmission, false);
  ...
  assert.equal(preflight.orderSubmissionAttempted, false);
  assert.equal(preflight.persistentStorageUsed, false);
  assert.equal(preflight.dbWriteUsed, false);
  assert.equal(preflight.actualPerformanceRecordUpdated, false);
  assert.equal(preflight.actualCashUpdated, false);
  assert.equal(preflight.actualPositionUpdated, false);
  assert.equal(preflight.actualPortfolioLedgerUpdated, false);
  assert.equal(preflight.accountBalanceQueried, false);
  assert.equal(serialized.includes("APP_KEY"), false);
  assert.equal(serialized.includes("APP_SECRET"), false);
  assert.equal(serialized.includes("containsAccountIdentifier\":true"), false);
  assert.equal(serialized.includes("containsProviderPayload\":true"), false);
  assert.equal(serialized.includes("containsOrderPayload\":true"), false);
  assert.equal(serialized.includes("rawProviderResponse\":true"), false);
  assert.equal(serialized.includes("hashValue\":true"), false);
  assert.equal(serialized.includes("digestValue\":true"), false);
});

test("Step 154 mock portfolio performance recalculation preflight blocks missing unsafe and invalid dependencies", () => {
  const missingValidation = validateTradingLabMockPortfolioPerformanceRecalculationPreflight({
    mockPortfolioLedgerUpdateCoreStatus: null,
  });
  const unsafeValidation = validateTradingLabMockPortfolioPerformanceRecalculationPreflight({
    mockPortfolioLedgerUpdateCoreStatus: {
      ledgerUpdateResult: {
        ledgerUpdateResultId: "unsafe_ledger_update_result",
        scope: "mock_only",
        redacted: false,
        updateStatus: "mock_ledger_updated",
        readinessImpact: "none",
        providerCallImpact: "blocked",
        orderSubmissionImpact: "blocked",
        liveTradingImpact: "blocked",
  ...
  const negativeValidation = validateTradingLabMockPortfolioPerformanceRecalculationPreflight({
    equityBeforePlaceholder: 1000,
    equityAfterPreview: -10,
  });
  const invalidReturnValidation = validateTradingLabMockPortfolioPerformanceRecalculationPreflight({
    performanceInputBundle: {
      ...buildTradingLabMockPerformanceRecalculationInputBundle(),
      equityBeforePlaceholder: 0,
      equityAfterPreview: 500,
  ...
  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_core_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_portfolio_ledger_update_result_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_portfolio_ledger_update_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("actual_ledger_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_cash_position_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("persistent_db_write_must_not_run"));
  assert.equal(negativeValidation.status, "validation_required");
  assert.ok(negativeValidation.warnings.includes("mock_equity_preview_negative"));
  assert.equal(invalidReturnValidation.status, "validation_required");
  assert.ok(invalidReturnValidation.warnings.includes("mock_prior_equity_missing_or_zero"));
  assert.ok(invalidReturnValidation.warnings.includes("mock_equity_series_dependency_missing"));
  assert.ok(invalidReturnValidation.warnings.includes("mock_return_series_dependency_missing"));
});

test("Step 154 admin mock portfolio performance recalculation preflight status and dashboard integration remain admin-only fail-closed", () => {
  const status = buildAdminTradingLabMockPortfolioPerformanceRecalculationPreflightStatus();
  const dashboard = buildAdminTradingLabDashboardStatus();
  const serialized = JSON.stringify({ status, dashboard });

  assert.equal(status.step, "Step 154: Admin trading lab mock portfolio performance recalculation preflight");
  assert.equal(status.status, "admin_only_trading_lab_mock_portfolio_performance_recalculation_preflight_fail_closed");
  assert.equal(status.boundaries.adminOnly, true);
  assert.equal(status.boundaries.publicDashboardExposed, false);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.actualPerformanceRecordUpdateAllowed, false);
  assert.equal(status.boundaries.persistentDbWriteRequired, false);
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
  ...
  assert.equal(status.persistentStorageUsed, false);
  assert.equal(status.dbWriteUsed, false);
  assert.equal(status.actualPerformanceRecordUpdated, false);
  assert.equal(status.actualCashUpdated, false);
  assert.equal(status.actualPositionUpdated, false);
  assert.equal(status.actualPortfolioLedgerUpdated, false);
  assert.equal(status.accountBalanceQueried, false);
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.mockPortfolioLedgerUpdateCoreStatus.step, "Step 153: Admin trading lab mock portfolio ledger update core");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationPreflightStatus.step, "Step 154: Admin trading lab mock portfolio performance recalculation preflight");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationPreflightModel.sourceStep, "step154");
  assert.equal(dashboard.mockPerformanceRecalculationInputBundleModel.sourceStep, "step154");
  assert.equal(dashboard.mockPerformanceRecalculationScenarioModel.sourceStep, "step154");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
  ...
  assert.equal(serialized.includes("persistentStorageUsed\":true"), false);
  assert.equal(serialized.includes("dbWriteUsed\":true"), false);
  assert.equal(serialized.includes("actualPerformanceRecordUpdated\":true"), false);
  assert.equal(serialized.includes("actualPortfolioLedgerUpdated\":true"), false);
  assert.equal(serialized.includes("actualCashUpdated\":true"), false);
  assert.equal(serialized.includes("actualPositionUpdated\":true"), false);
  assert.equal(serialized.includes("accountBalanceQueried\":true"), false);
...
test("Step 155 mock portfolio performance recalculation review result records redacted receipt without performance mutation", () => {
  const status = buildAdminTradingLabMockPortfolioPerformanceRecalculationReviewResultStatus();
  const validation = validateTradingLabMockPortfolioPerformanceRecalculationReviewResult();
  const reviewResult = buildTradingLabMockPortfolioPerformanceRecalculationReviewResult({ validation });
  const gate = buildTradingLabMockPortfolioPerformanceRecalculationReviewResultRecordingGate({ validation, reviewResult });
  const reviewSummary = buildTradingLabMockPerformanceRecalculationReviewSummary({ validation });
  const decisionSummary = buildTradingLabMockPerformanceRecalculationReviewDecisionSummary({ validation });
  const serialized = JSON.stringify({ status, validation, reviewResult, gate, reviewSummary, decisionSummary });

  assert.equal(status.step, "Step 155: Admin trading lab mock portfolio performance recalculation review result recording gate");
  assert.equal(status.status, "admin_only_trading_lab_mock_portfolio_performance_recalculation_review_result_fail_closed");
  assert.equal(status.mockPortfolioPerformanceRecalculationReviewResultModel.sourceStep, "step155");
  assert.equal(status.mockPerformanceRecalculationReviewReceiptSchema.nextAllowedStep, "mock_portfolio_performance_recalculation_core");
  assert.equal(validation.status, "recorded");
  assert.equal(validation.equitySeriesReviewStatus, "reviewed");
  assert.equal(validation.dailyReturnReviewStatus, "reviewed");
  assert.equal(validation.cumulativeReturnReviewStatus, "reviewed");
  assert.equal(validation.drawdownReviewStatus, "reviewed");
  assert.equal(validation.mddReviewStatus, "reviewed");
  assert.equal(validation.allocationReviewStatus, "reviewed");
  assert.equal(reviewResult.reviewStatus, "recorded");
  assert.equal(reviewResult.decision, "mock_performance_recalculation_review_recorded");
  assert.equal(reviewResult.redacted, true);
  assert.equal(reviewResult.readinessImpact, "none");
  assert.equal(reviewResult.providerCallImpact, "blocked");
  assert.equal(reviewResult.orderSubmissionImpact, "blocked");
  assert.equal(reviewResult.liveTradingImpact, "blocked");
  assert.equal(gate.receipt.redacted, true);
  assert.equal(gate.receipt.nextAllowedStep, "mock_portfolio_performance_recalculation_core");
  assert.equal(gate.receipt.reviewStatus, "recorded");
  assert.equal(gate.receipt.decision, "mock_performance_recalculation_review_recorded");
  assert.equal(reviewSummary.redacted, true);
  assert.equal(decisionSummary.decision, "mock_performance_recalculation_review_recorded");
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
  assert.equal(status.readyForOrderSubmission, false);
...
test("Step 155 mock portfolio performance recalculation review result blocks missing unsafe and invalid dependencies", () => {
  const preflight = buildAdminTradingLabMockPortfolioPerformanceRecalculationPreflightStatus();
  const missingValidation = validateTradingLabMockPortfolioPerformanceRecalculationReviewResult({
    mockPortfolioPerformanceRecalculationPreflightStatus: null,
  });
  const unsafeValidation = validateTradingLabMockPortfolioPerformanceRecalculationReviewResult({
    ...
    performanceRecalculationPreflightResult: {
      ...preflight.result,
      redacted: false,
      scope: "live",
      readinessImpact: "ready",
      ...
      orderSubmissionImpact: "allowed",
      liveTradingImpact: "ready",
      nextAllowedStep: "live_trading",
    },
    performanceInputBundle: {
      ...preflight.performanceInputBundle,
      redacted: false,
      scope: "live",
      actualPerformanceRecordUpdated: true,
      actualCashUpdated: true,
  ...
  const negativeValidation = validateTradingLabMockPortfolioPerformanceRecalculationReviewResult({
    performanceRecalculationPreflightResult: {
      ...preflight.result,
      equityAfterPreview: -10,
    },
  });
  const invalidReturnValidation = validateTradingLabMockPortfolioPerformanceRecalculationReviewResult({
    performanceRecalculationPreflightResult: {
      ...preflight.result,
      dailyReturnPreview: 150,
    },
  });

  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_performance_recalculation_preflight_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_performance_recalculation_preflight_result_missing"));
  assert.ok(missingValidation.blockers.includes("mock_performance_recalculation_input_bundle_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_performance_recalculation_preflight_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_recalculation_preflight_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("performance_recalculation_readiness_impact_not_none"));
  assert.ok(unsafeValidation.blockers.includes("performance_recalculation_provider_call_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("actual_performance_record_must_not_update"));
  assert.ok(unsafeValidation.blockers.includes("actual_cash_position_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_portfolio_ledger_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_account_balance_query_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("persistent_db_write_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("kis_order_execution_fill_payload_must_not_be_created"));
  assert.ok(unsafeValidation.blockers.includes("status_actual_performance_record_must_not_update"));
  assert.equal(negativeValidation.status, "validation_required");
  assert.ok(negativeValidation.warnings.includes("mock_equity_preview_negative"));
  assert.equal(invalidReturnValidation.status, "validation_required");
  assert.ok(invalidReturnValidation.warnings.includes("mock_daily_return_preview_invalid"));
});

test("Step 155 admin mock portfolio performance recalculation review result status and dashboard integration remain admin-only fail-closed", () => {
  const status = buildAdminTradingLabMockPortfolioPerformanceRecalculationReviewResultStatus();
  const dashboard = buildAdminTradingLabDashboardStatus();
  const serialized = JSON.stringify({ status, dashboard });
  ...
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.actualPerformanceRecordUpdateAllowed, false);
  assert.equal(status.boundaries.actualLedgerUpdateAllowed, false);
  assert.equal(status.boundaries.actualCashUpdateAllowed, false);
  assert.equal(status.boundaries.actualPositionUpdateAllowed, false);
  assert.equal(status.boundaries.accountBalanceQueryAllowed, false);
  assert.equal(status.boundaries.persistentDbWriteRequired, false);
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
  ...
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationPreflightStatus.step, "Step 154: Admin trading lab mock portfolio performance recalculation preflight");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationReviewResultStatus.step, "Step 155: Admin trading lab mock portfolio performance recalculation review result recording gate");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationReviewResultModel.sourceStep, "step155");
  assert.equal(dashboard.mockPerformanceRecalculationReviewReceiptSchema.sourceStep, "step155");
  assert.equal(dashboard.mockPerformanceRecalculationReviewDecisionSummaryModel.sourceStep, "step155");
  assert.equal(dashboard.mockPerformanceRecalculationReviewSummaryModel.sourceStep, "step155");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
...
test("Step 156 mock portfolio performance recalculation core preflight builds deterministic redacted readiness without performance mutation", () => {
  const status = buildAdminTradingLabMockPortfolioPerformanceRecalculationCorePreflightStatus();
  const bundle = buildTradingLabMockPerformanceCoreInputBundle();
  const scenario = buildTradingLabMockPerformanceCoreScenario();
  const validation = validateTradingLabMockPortfolioPerformanceRecalculationCorePreflight({ performanceCoreInputBundle: bundle, performanceCoreScenario: scenario });
  const preflight = buildTradingLabMockPortfolioPerformanceRecalculationCorePreflight({ performanceCoreInputBundle: bundle, performanceCoreScenario: scenario, validation });
  const serialized = JSON.stringify({ status, bundle, scenario, validation, preflight });

  assert.equal(status.step, "Step 156: Admin trading lab mock portfolio performance recalculation core preflight");
  assert.equal(status.status, "admin_only_trading_lab_mock_portfolio_performance_recalculation_core_preflight_fail_closed");
  assert.equal(status.mockPortfolioPerformanceRecalculationCorePreflightModel.sourceStep, "step156");
  assert.equal(status.mockPerformanceCoreInputBundleModel.sourceStep, "step156");
  assert.equal(status.mockPerformanceCoreScenarioModel.sourceStep, "step156");
  assert.equal(status.mockPerformanceCorePreflightResultSchema.nextAllowedStep, "mock_portfolio_performance_recalculation_core");
  assert.equal(bundle.scope, "mock_only");
  assert.equal(bundle.redacted, true);
  ...
  assert.equal(validation.status, "mock_performance_core_ready");
  assert.equal(validation.equitySeriesPolicyStatus, "ready");
  assert.equal(validation.dailyReturnPolicyStatus, "ready");
  assert.equal(validation.cumulativeReturnPolicyStatus, "ready");
  assert.equal(validation.drawdownPolicyStatus, "ready");
  assert.equal(validation.mddPolicyStatus, "ready");
  assert.equal(validation.allocationPolicyStatus, "ready");
  assert.equal(validation.realizedPnlPolicyStatus, "placeholder_only");
  assert.equal(validation.unrealizedPnlPolicyStatus, "placeholder_only");
  assert.equal(validation.kpiSummaryPolicyStatus, "ready");
  assert.equal(validation.chartDataPolicyStatus, "ready");
  assert.equal(validation.deterministicCalculationStatus, "ready");
  assert.equal(validation.dependencyStatus, "satisfied");
  assert.equal(preflight.result.scope, "mock_only");
  assert.equal(preflight.result.redacted, true);
  assert.equal(preflight.result.status, "mock_performance_core_ready");
  assert.equal(preflight.result.readinessImpact, "none");
  assert.equal(preflight.result.providerCallImpact, "blocked");
  assert.equal(preflight.result.orderSubmissionImpact, "blocked");
  assert.equal(preflight.result.liveTradingImpact, "blocked");
  ...
  assert.equal(preflight.actualExecutionCreated, false);
  assert.equal(preflight.actualFillRecordCreated, false);
  assert.equal(preflight.actualPerformanceRecordCreated, false);
  assert.equal(preflight.actualPerformanceRecordUpdated, false);
  assert.equal(preflight.actualPortfolioLedgerUpdated, false);
  assert.equal(preflight.actualCashUpdated, false);
  assert.equal(preflight.actualPositionUpdated, false);
...
test("Step 156 mock portfolio performance recalculation core preflight blocks missing unsafe and invalid dependencies", () => {
  const reviewStatus = buildAdminTradingLabMockPortfolioPerformanceRecalculationReviewResultStatus();
  const missingValidation = validateTradingLabMockPortfolioPerformanceRecalculationCorePreflight({
    mockPortfolioPerformanceRecalculationReviewResultStatus: null,
  });
  const unsafeValidation = validateTradingLabMockPortfolioPerformanceRecalculationCorePreflight({
    ...
    performanceCoreScenario: {
      ...
      scope: "live",
      deterministic: false,
      equityPolicy: "provider_quote",
    },
  });
  const negativeValidation = validateTradingLabMockPortfolioPerformanceRecalculationCorePreflight({
    performanceCoreInputBundle: {
      ...buildTradingLabMockPerformanceCoreInputBundle(),
      equityAfterPreview: -10,
    },
  });
  const invalidReturnValidation = validateTradingLabMockPortfolioPerformanceRecalculationCorePreflight({
    performanceCoreInputBundle: {
      ...buildTradingLabMockPerformanceCoreInputBundle(),
      equityBeforePlaceholder: 1,
      equityAfterPreview: 200,
    },
  });

  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_performance_recalculation_review_result_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_performance_recalculation_review_result_missing"));
  assert.ok(missingValidation.blockers.includes("mock_performance_recalculation_review_receipt_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_performance_recalculation_review_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_recalculation_review_not_recorded"));
  assert.ok(unsafeValidation.blockers.includes("performance_core_provider_call_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_input_bundle_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_input_bundle_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_scenario_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_scenario_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("actual_performance_record_must_not_change"));
  assert.ok(unsafeValidation.blockers.includes("actual_cash_position_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_portfolio_ledger_update_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("actual_account_balance_query_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("persistent_db_write_must_not_run"));
...
test("Step 156 admin mock portfolio performance recalculation core preflight status and dashboard integration remain admin-only fail-closed", () => {
  const status = buildAdminTradingLabMockPortfolioPerformanceRecalculationCorePreflightStatus();
  const dashboard = buildAdminTradingLabDashboardStatus();
  const serialized = JSON.stringify({ status, dashboard });
  ...
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.actualPerformanceRecordCreateAllowed, false);
  assert.equal(status.boundaries.actualPerformanceRecordUpdateAllowed, false);
  assert.equal(status.boundaries.actualLedgerUpdateAllowed, false);
  assert.equal(status.boundaries.actualCashUpdateAllowed, false);
  assert.equal(status.boundaries.actualPositionUpdateAllowed, false);
  ...
  assert.equal(status.persistentStorageUsed, false);
  assert.equal(status.dbWriteUsed, false);
  assert.equal(status.actualPerformanceRecordCreated, false);
  assert.equal(status.actualPerformanceRecordUpdated, false);
  assert.equal(status.actualCashUpdated, false);
  assert.equal(status.actualPositionUpdated, false);
  assert.equal(status.actualPortfolioLedgerUpdated, false);
  ...
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationReviewResultStatus.step, "Step 155: Admin trading lab mock portfolio performance recalculation review result recording gate");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCorePreflightStatus.step, "Step 156: Admin trading lab mock portfolio performance recalculation core preflight");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCorePreflightModel.sourceStep, "step156");
  assert.equal(dashboard.mockPerformanceCoreInputBundleModel.sourceStep, "step156");
  assert.equal(dashboard.mockPerformanceCoreScenarioModel.sourceStep, "step156");
  assert.equal(dashboard.mockPerformanceCorePreflightResultSchema.sourceStep, "step156");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
  ...
  assert.equal(serialized.includes("persistentStorageUsed\":true"), false);
  assert.equal(serialized.includes("dbWriteUsed\":true"), false);
  assert.equal(serialized.includes("actualPerformanceRecordCreated\":true"), false);
  assert.equal(serialized.includes("actualPerformanceRecordUpdated\":true"), false);
  assert.equal(serialized.includes("actualPortfolioLedgerUpdated\":true"), false);
  assert.equal(serialized.includes("actualCashUpdated\":true"), false);
  assert.equal(serialized.includes("actualPositionUpdated\":true"), false);
...
test("Step 157 mock portfolio performance recalculation core review result records redacted receipt without performance mutation", () => {
  const status = buildAdminTradingLabMockPortfolioPerformanceRecalculationCoreReviewResultStatus();
  const validation = validateTradingLabMockPortfolioPerformanceRecalculationCoreReviewResult();
  const reviewResult = buildTradingLabMockPortfolioPerformanceRecalculationCoreReviewResult({ validation });
  const gate = buildTradingLabMockPortfolioPerformanceRecalculationCoreReviewResultRecordingGate({ validation, reviewResult });
  const policyReviewSummary = buildTradingLabMockPerformanceCorePolicyReviewSummary({ validation });
  const decisionSummary = buildTradingLabMockPerformanceCoreReviewDecisionSummary({ validation });
  const serialized = JSON.stringify({ status, validation, reviewResult, gate, policyReviewSummary, decisionSummary });

  assert.equal(status.step, "Step 157: Admin trading lab mock portfolio performance recalculation core review result recording gate");
  assert.equal(status.status, "admin_only_trading_lab_mock_portfolio_performance_recalculation_core_review_result_fail_closed");
  assert.equal(status.mockPortfolioPerformanceRecalculationCoreReviewResultModel.sourceStep, "step157");
  assert.equal(status.mockPerformanceCoreReviewReceiptSchema.nextAllowedStep, "mock_portfolio_performance_recalculation_core");
  assert.equal(status.mockPerformanceCoreReviewDecisionSummaryModel.sourceStep, "step157");
  assert.equal(status.mockPerformanceCorePolicyReviewSummaryModel.sourceStep, "step157");
  assert.equal(validation.status, "recorded");
  assert.equal(validation.equitySeriesPolicyReviewStatus, "reviewed");
  assert.equal(validation.dailyReturnPolicyReviewStatus, "reviewed");
  assert.equal(validation.cumulativeReturnPolicyReviewStatus, "reviewed");
  assert.equal(validation.drawdownPolicyReviewStatus, "reviewed");
  assert.equal(validation.mddPolicyReviewStatus, "reviewed");
  assert.equal(validation.allocationPolicyReviewStatus, "reviewed");
  assert.equal(validation.realizedPnlPolicyReviewStatus, "reviewed");
  assert.equal(validation.unrealizedPnlPolicyReviewStatus, "reviewed");
  assert.equal(validation.kpiSummaryPolicyReviewStatus, "reviewed");
  assert.equal(validation.chartDataPolicyReviewStatus, "reviewed");
  assert.equal(validation.deterministicCalculationReviewStatus, "reviewed");
  assert.equal(reviewResult.reviewStatus, "recorded");
  assert.equal(reviewResult.decision, "mock_performance_core_review_recorded");
  assert.equal(reviewResult.redacted, true);
  assert.equal(gate.receipt.redacted, true);
  assert.equal(gate.receipt.reviewStatus, "recorded");
  assert.equal(gate.receipt.nextAllowedStep, "mock_portfolio_performance_recalculation_core");
  assert.equal(policyReviewSummary.redacted, true);
  assert.equal(decisionSummary.externalOrderAuthorityRequired, true);
  assert.equal(gate.providerCallsAllowed, false);
  assert.equal(gate.orderSubmissionAllowed, false);
  assert.equal(gate.readyForReadOnlyProviderCalls, false);
  assert.equal(gate.readyForOrderSubmission, false);
  assert.equal(gate.readyForLiveGuardedTrading, false);
  assert.equal(gate.tokenIssuanceAttempted, false);
  assert.equal(gate.quoteRequestAttempted, false);
  assert.equal(gate.networkCallAttempted, false);
  assert.equal(gate.orderSubmissionAttempted, false);
  assert.equal(gate.actualOrderCandidateCreated, false);
  assert.equal(gate.actualOrderDraftCreated, false);
  assert.equal(gate.kisOrderPayloadCreated, false);
  assert.equal(gate.kisExecutionPayloadCreated, false);
  assert.equal(gate.kisFillPayloadCreated, false);
  assert.equal(gate.actualExecutionCreated, false);
  assert.equal(gate.actualFillRecordCreated, false);
  assert.equal(gate.actualPerformanceRecordCreated, false);
  assert.equal(gate.actualPerformanceRecordUpdated, false);
  assert.equal(gate.actualPortfolioLedgerUpdated, false);
  assert.equal(gate.actualCashUpdated, false);
  assert.equal(gate.actualPositionUpdated, false);
  assert.equal(gate.accountBalanceQueried, false);
  assert.equal(gate.persistentStorageUsed, false);
  assert.equal(gate.dbWriteUsed, false);
  assert.equal(serialized.includes("APP_KEY"), false);
  assert.equal(serialized.includes("APP_SECRET"), false);
  assert.equal(serialized.includes("actualOrderId"), false);
  assert.equal(serialized.includes("actualExecutionId"), false);
  assert.equal(serialized.includes("actualFillId"), false);
  assert.equal(serialized.includes("actualAccountBalance"), false);
  assert.equal(serialized.includes("actualPerformanceRecordId"), false);
  assert.equal(serialized.includes("containsAccountIdentifier\":true"), false);
  assert.equal(serialized.includes("containsProviderPayload\":true"), false);
  assert.equal(serialized.includes("containsOrderPayload\":true"), false);
  assert.equal(serialized.includes("rawProviderResponse\":true"), false);
...
test("Step 157 mock portfolio performance recalculation core review result blocks missing unsafe and invalid dependencies", () => {
  const preflightStatus = buildAdminTradingLabMockPortfolioPerformanceRecalculationCorePreflightStatus();
  const missingValidation = validateTradingLabMockPortfolioPerformanceRecalculationCoreReviewResult({
    mockPortfolioPerformanceRecalculationCorePreflightStatus: null,
  });
  const unsafeValidation = validateTradingLabMockPortfolioPerformanceRecalculationCoreReviewResult({
    mockPortfolioPerformanceRecalculationCorePreflightStatus: {
      ...
      performanceCoreInputBundle: {
        ...preflightStatus.performanceCoreInputBundle,
        redacted: false,
        scope: "live",
        actualPerformanceRecordCreated: true,
        actualPerformanceRecordUpdated: true,
  ...
  const negativeValidation = validateTradingLabMockPortfolioPerformanceRecalculationCoreReviewResult({
    mockPortfolioPerformanceRecalculationCorePreflightStatus: {
      ...preflightStatus,
      result: {
        ...preflightStatus.result,
        equityAfterPreview: -1,
      },
      validation: {
        ...preflightStatus.validation,
        equityAfterPreview: -1,
  ...
  const invalidReturnValidation = validateTradingLabMockPortfolioPerformanceRecalculationCoreReviewResult({
    mockPortfolioPerformanceRecalculationCorePreflightStatus: {
      ...preflightStatus,
      result: {
        ...preflightStatus.result,
        dailyReturnPreview: 101,
      },
      validation: {
        ...preflightStatus.validation,
        dailyReturnPreview: 101,
  ...
  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_performance_core_preflight_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_performance_core_preflight_result_missing"));
  assert.ok(missingValidation.blockers.includes("mock_performance_core_input_bundle_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_preflight_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_preflight_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("performance_core_review_provider_call_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_preflight_blocked"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_input_bundle_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_input_bundle_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("actual_performance_record_must_not_change"));
  assert.ok(unsafeValidation.blockers.includes("actual_cash_position_update_must_not_run"));
  ...
  assert.ok(unsafeValidation.blockers.includes("persistent_db_write_must_not_run"));
  assert.ok(unsafeValidation.blockers.includes("kis_order_execution_fill_payload_must_not_be_created"));
  assert.ok(unsafeValidation.blockers.includes("status_actual_performance_record_must_not_create"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_private_or_payload_value_rejected"));
  assert.equal(negativeValidation.status, "validation_required");
  assert.ok(negativeValidation.warnings.includes("mock_equity_preview_negative"));
  assert.equal(invalidReturnValidation.status, "validation_required");
  assert.ok(invalidReturnValidation.warnings.includes("mock_daily_return_preview_invalid"));
...
test("Step 157 admin mock portfolio performance recalculation core review result status and dashboard integration remain admin-only fail-closed", () => {
  const status = buildAdminTradingLabMockPortfolioPerformanceRecalculationCoreReviewResultStatus();
  const dashboard = buildAdminTradingLabDashboardStatus();
  const serialized = JSON.stringify({ status, dashboard });
  ...
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCorePreflightStatus.step, "Step 156: Admin trading lab mock portfolio performance recalculation core preflight");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCoreReviewResultStatus.step, "Step 157: Admin trading lab mock portfolio performance recalculation core review result recording gate");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCoreReviewResultModel.sourceStep, "step157");
  assert.equal(dashboard.mockPerformanceCoreReviewReceiptSchema.sourceStep, "step157");
  assert.equal(dashboard.mockPerformanceCoreReviewDecisionSummaryModel.sourceStep, "step157");
  assert.equal(dashboard.mockPerformanceCorePolicyReviewSummaryModel.sourceStep, "step157");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
...
test("Step 158 mock portfolio performance recalculation core calculates deterministic redacted mock performance without mutation", () => {
  const status = buildAdminTradingLabMockPortfolioPerformanceRecalculationCoreStatus();
  const validation = validateTradingLabMockPortfolioPerformanceRecalculationCore();
  const performanceResult = calculateTradingLabMockPortfolioPerformanceResult();
  const repeatedPerformanceResult = calculateTradingLabMockPortfolioPerformanceResult();
  const core = buildTradingLabMockPortfolioPerformanceRecalculationCore({ validation, performanceResult });
  const serialized = JSON.stringify({ status, validation, performanceResult, repeatedPerformanceResult, core });

  assert.equal(status.step, "Step 158: Admin trading lab mock portfolio performance recalculation core");
  assert.equal(status.status, "admin_only_trading_lab_mock_portfolio_performance_recalculation_core_fail_closed");
  assert.equal(status.mockPortfolioPerformanceRecalculationCoreModel.sourceStep, "step158");
  assert.equal(status.mockPerformanceResultModel.sourceStep, "step158");
  assert.equal(status.mockEquitySeriesResultModel.sourceStep, "step158");
  assert.equal(status.mockDailyReturnResultModel.sourceStep, "step158");
  assert.equal(status.mockCumulativeReturnResultModel.sourceStep, "step158");
  assert.equal(status.mockDrawdownMddResultModel.sourceStep, "step158");
  assert.equal(status.mockAllocationResultModel.sourceStep, "step158");
  assert.equal(status.mockKpiSummaryResultModel.sourceStep, "step158");
  assert.equal(status.mockChartDataResultModel.sourceStep, "step158");
  assert.equal(status.mockPerformanceResultSchema.nextAllowedStep, "mock_trading_run_summary_preflight");
  assert.equal(validation.status, "mock_performance_calculated");
  assert.equal(validation.equitySeriesStatus, "calculated");
  assert.equal(validation.dailyReturnStatus, "calculated");
  assert.equal(validation.cumulativeReturnStatus, "calculated");
  assert.equal(validation.drawdownStatus, "calculated");
  assert.equal(validation.mddStatus, "calculated");
  assert.equal(validation.allocationStatus, "calculated");
  assert.equal(validation.kpiSummaryStatus, "calculated");
  assert.equal(validation.chartDataStatus, "calculated");
  assert.deepEqual(performanceResult, repeatedPerformanceResult);
  assert.equal(performanceResult.redacted, true);
  assert.equal(performanceResult.scope, "mock_only");
  assert.equal(performanceResult.deterministic, true);
  assert.ok(Array.isArray(performanceResult.equitySeries));
  assert.ok(Array.isArray(performanceResult.dailyReturnSeries));
  assert.ok(Array.isArray(performanceResult.cumulativeReturnSeries));
  assert.ok(Array.isArray(performanceResult.drawdownSeries));
  assert.ok(Array.isArray(performanceResult.allocationSnapshot));
  assert.equal(performanceResult.kpiSummary.redacted, true);
  assert.equal(performanceResult.chartData.redacted, true);
  assert.equal(core.providerCallsAllowed, false);
  assert.equal(core.orderSubmissionAllowed, false);
  assert.equal(core.readyForReadOnlyProviderCalls, false);
  assert.equal(core.readyForOrderSubmission, false);
  assert.equal(core.readyForLiveGuardedTrading, false);
  assert.equal(core.tokenIssuanceAttempted, false);
  assert.equal(core.quoteRequestAttempted, false);
  assert.equal(core.networkCallAttempted, false);
  assert.equal(core.orderSubmissionAttempted, false);
  assert.equal(core.actualOrderCandidateCreated, false);
  assert.equal(core.actualOrderDraftCreated, false);
  assert.equal(core.kisOrderPayloadCreated, false);
  assert.equal(core.kisExecutionPayloadCreated, false);
  assert.equal(core.kisFillPayloadCreated, false);
  assert.equal(core.actualExecutionCreated, false);
  assert.equal(core.actualFillRecordCreated, false);
  assert.equal(core.actualPerformanceRecordCreated, false);
  assert.equal(core.actualPerformanceRecordUpdated, false);
  assert.equal(core.actualPortfolioLedgerUpdated, false);
  assert.equal(core.actualCashUpdated, false);
  assert.equal(core.actualPositionUpdated, false);
  assert.equal(core.accountBalanceQueried, false);
  assert.equal(core.persistentStorageUsed, false);
  assert.equal(core.dbWriteUsed, false);
  assert.equal(core.actualInvestmentPerformanceConfirmed, false);
  assert.equal(core.returnGuaranteeProvided, false);
  assert.equal(core.investmentAdviceProvided, false);
  assert.equal(serialized.includes("APP_KEY"), false);
  assert.equal(serialized.includes("APP_SECRET"), false);
  assert.equal(serialized.includes("actualOrderId"), false);
  assert.equal(serialized.includes("actualExecutionId"), false);
...
test("Step 158 mock portfolio performance recalculation core blocks missing unsafe and invalid dependencies", () => {
  const reviewStatus = buildAdminTradingLabMockPortfolioPerformanceRecalculationCoreReviewResultStatus();
  const missingValidation = validateTradingLabMockPortfolioPerformanceRecalculationCore({
    mockPortfolioPerformanceRecalculationCoreReviewResultStatus: null,
  });
  const unsafeValidation = validateTradingLabMockPortfolioPerformanceRecalculationCore({
    ...
    performanceResultInput: {
      credential: "APP_SECRET",
      providerPayload: { raw: true },
    },
  });
  const negativeValidation = validateTradingLabMockPortfolioPerformanceRecalculationCore({
    performanceCoreInputBundle: {
      ...buildTradingLabMockPerformanceCoreInputBundle(),
      equityAfterPreview: -1,
      priorEquitySeriesPlaceholder: [100, -1],
    },
  });
  const invalidReturnValidation = validateTradingLabMockPortfolioPerformanceRecalculationCore({
    performanceResult: {
      ...calculateTradingLabMockPortfolioPerformanceResult(),
      dailyReturnSeries: [{ dailyReturn: 101 }],
      redacted: true,
      scope: "mock_only",
      deterministic: true,
    },
  ...
  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_performance_core_review_result_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_performance_core_review_result_missing"));
  assert.ok(missingValidation.blockers.includes("mock_performance_core_review_receipt_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_review_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_review_not_recorded"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_result_provider_call_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_input_bundle_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_core_input_bundle_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("actual_performance_record_must_not_change"));
  assert.ok(unsafeValidation.blockers.includes("actual_cash_position_update_must_not_run"));
  ...
  assert.ok(unsafeValidation.blockers.includes("kis_order_execution_fill_payload_must_not_be_created"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_private_or_payload_value_rejected"));
  assert.ok(["blocked", "validation_required"].includes(negativeValidation.status));
  assert.ok(negativeValidation.warnings.includes("mock_equity_series_negative"));
  assert.ok(["blocked", "validation_required"].includes(invalidReturnValidation.status));
  assert.ok(invalidReturnValidation.warnings.includes("mock_daily_return_invalid"));
});

test("Step 158 admin mock portfolio performance recalculation core status and dashboard integration remain admin-only fail-closed", () => {
  const status = buildAdminTradingLabMockPortfolioPerformanceRecalculationCoreStatus();
  const dashboard = buildAdminTradingLabDashboardStatus();
  const serialized = JSON.stringify({ status, dashboard });
  ...
  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCoreReviewResultStatus.step, "Step 157: Admin trading lab mock portfolio performance recalculation core review result recording gate");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCoreStatus.step, "Step 158: Admin trading lab mock portfolio performance recalculation core");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCoreModel.sourceStep, "step158");
  assert.equal(dashboard.mockPerformanceResultModel.sourceStep, "step158");
  assert.equal(dashboard.mockPerformanceResultSchema.sourceStep, "step158");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
...
test("Step 159 admin mock trading run summary preflight builds redacted mock-only summary readiness without side effects", () => {
  const status = buildAdminTradingLabMockTradingRunSummaryPreflightStatus();
  const bundle = buildTradingLabMockTradingRunSummaryInputBundle();
  const validation = validateTradingLabMockTradingRunSummaryPreflight({ summaryInputBundle: bundle });
  const preflight = buildTradingLabMockTradingRunSummaryPreflight({ summaryInputBundle: bundle, validation });
  const serialized = JSON.stringify({ status, bundle, validation, preflight });

  assert.equal(status.step, "Step 159: Admin trading lab mock trading run summary preflight");
  assert.equal(status.status, "admin_only_trading_lab_mock_trading_run_summary_preflight_fail_closed");
  assert.equal(status.mockTradingRunSummaryPreflightModel.sourceStep, "step159");
  assert.equal(status.mockTradingRunSummaryInputBundleModel.sourceStep, "step159");
  assert.equal(status.mockTradingRunChainDependencyMapModel.sourceStep, "step159");
  assert.equal(status.mockTradingRunSummaryPreflightResultSchema.sourceStep, "step159");
  assert.equal(status.result.scope, "mock_only");
  assert.equal(status.result.redacted, true);
  assert.equal(status.result.nextAllowedStep, "mock_trading_run_summary_review_result");
  assert.equal(status.summaryInputBundle.redacted, true);
  assert.equal(status.summaryInputBundle.scope, "mock_only");
  assert.equal(status.summaryInputBundle.dbWriteUsed, false);
  assert.equal(status.summaryInputBundle.persistentStorageUsed, false);
  assert.equal(status.summaryInputBundle.orderCandidateCreated, false);
  assert.equal(status.summaryInputBundle.orderDraftCreated, false);
  assert.equal(status.summaryInputBundle.executionRecordCreated, false);
  assert.equal(status.summaryInputBundle.fillRecordCreated, false);
  assert.equal(status.summaryInputBundle.portfolioLedgerPersisted, false);
  assert.equal(status.summaryInputBundle.performanceRecordPersisted, false);
  assert.equal(status.summaryInputBundle.accountBalanceQueried, false);
  assert.equal(status.summaryInputBundle.cashPositionMutated, false);
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
  assert.equal(status.readyForOrderSubmission, false);
  ...
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.persistentDbWriteRequired, false);
  assert.equal(status.boundaries.portfolioLedgerPersistenceAllowed, false);
  assert.equal(status.boundaries.performanceRecordPersistenceAllowed, false);
  assert.equal(status.boundaries.accountBalanceQueryAllowed, false);
  assert.equal(status.boundaries.cashPositionMutationAllowed, false);
  assert.equal(validation.status, "mock_summary_ready");
  assert.equal(preflight.result.status, "mock_summary_ready");
  assert.equal(serialized.includes("providerCallsAllowed\":true"), false);
  assert.equal(serialized.includes("orderSubmissionAllowed\":true"), false);
  assert.equal(serialized.includes("readyForReadOnlyProviderCalls\":true"), false);
  assert.equal(serialized.includes("readyForOrderSubmission\":true"), false);
  assert.equal(serialized.includes("readyForLiveGuardedTrading\":true"), false);
  assert.equal(serialized.includes("tokenIssuanceAttempted\":true"), false);
  assert.equal(serialized.includes("quoteRequestAttempted\":true"), false);
  assert.equal(serialized.includes("networkCallAttempted\":true"), false);
  assert.equal(serialized.includes("orderSubmissionAttempted\":true"), false);
  assert.equal(serialized.includes("orderPayloadCreated\":true"), false);
  assert.equal(serialized.includes("kisOrderPayloadCreated\":true"), false);
  assert.equal(serialized.includes("kisExecutionPayloadCreated\":true"), false);
  assert.equal(serialized.includes("kisFillPayloadCreated\":true"), false);
  assert.equal(serialized.includes("executionRecordCreated\":true"), false);
  assert.equal(serialized.includes("fillRecordCreated\":true"), false);
  assert.equal(serialized.includes("portfolioLedgerPersisted\":true"), false);
  assert.equal(serialized.includes("performanceRecordPersisted\":true"), false);
  assert.equal(serialized.includes("accountBalanceQueried\":true"), false);
  assert.equal(serialized.includes("cashPositionMutated\":true"), false);
  assert.equal(serialized.includes("persistentStorageUsed\":true"), false);
  assert.equal(serialized.includes("dbWriteUsed\":true"), false);
  assert.equal(serialized.includes("credential\":\""), false);
  assert.equal(serialized.includes("providerPayload\":\""), false);
  assert.equal(serialized.includes("orderPayload\":\""), false);
  assert.equal(serialized.includes("rawProviderResponse\":\""), false);
  assert.equal(serialized.includes("privatePath\":\""), false);
});

test("Step 159 admin mock trading run summary preflight blocks missing or unsafe Step158 dependency", () => {
  const missingValidation = validateTradingLabMockTradingRunSummaryPreflight({
    mockPortfolioPerformanceRecalculationCoreStatus: null,
  });
  const unsafeValidation = validateTradingLabMockTradingRunSummaryPreflight({
    performanceResult: {
      ...calculateTradingLabMockPortfolioPerformanceResult(),
      redacted: false,
      scope: "live",
  ...
  const chartValidation = validateTradingLabMockTradingRunSummaryPreflight({
    summaryInputBundle: {
      ...buildTradingLabMockTradingRunSummaryInputBundle(),
      mockChartSummary: { status: "validation_required", redacted: true },
      mockDashboardSections: [],
    },
  });

  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_performance_recalculation_core_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_performance_result_missing"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_performance_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_performance_result_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("mock_summary_provider_call_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("mock_summary_order_submission_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("mock_summary_live_trading_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_input_bundle_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_input_bundle_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("provider_calls_must_remain_blocked"));
  assert.ok(unsafeValidation.blockers.includes("order_submission_must_remain_blocked"));
  assert.ok(unsafeValidation.blockers.includes("summary_preflight_must_not_write_db"));
  assert.ok(unsafeValidation.blockers.includes("summary_preflight_must_not_create_order_artifacts"));
  assert.ok(unsafeValidation.blockers.includes("summary_preflight_must_not_create_execution_or_fill_records"));
  assert.ok(unsafeValidation.blockers.includes("summary_preflight_must_not_persist_ledger_or_performance"));
  assert.ok(unsafeValidation.blockers.includes("summary_preflight_must_not_query_or_mutate_account_state"));
  assert.ok(unsafeValidation.blockers.includes("summary_preflight_must_not_create_kis_payloads"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_private_or_payload_value_rejected"));
  assert.equal(chartValidation.status, "validation_required");
  assert.ok(chartValidation.warnings.includes("mock_chart_summary_validation_required"));
  assert.ok(chartValidation.warnings.includes("mock_dashboard_aggregation_incomplete"));
});

test("Step 159 admin mock trading run summary preflight dashboard integration keeps prior mock chain fail-closed", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.mockTradingRunSummaryPreflightStatus;
  ...
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCoreStatus.step, "Step 158: Admin trading lab mock portfolio performance recalculation core");
  assert.equal(dashboard.mockPortfolioPerformanceRecalculationCoreReviewResultStatus.step, "Step 157: Admin trading lab mock portfolio performance recalculation core review result recording gate");
  assert.equal(dashboard.mockTradingRunSummaryPreflightModel.sourceStep, "step159");
  assert.equal(dashboard.mockTradingRunSummaryInputBundleModel.sourceStep, "step159");
  assert.equal(dashboard.mockTradingRunSummaryPreflightResultSchema.sourceStep, "step159");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
...
test("Step 160 admin mock trading run summary review result records redacted receipt without side effects", () => {
  const status = buildAdminTradingLabMockTradingRunSummaryReviewResultStatus();
  const validation = validateTradingLabMockTradingRunSummaryReviewResult();
  const review = buildTradingLabMockTradingRunSummaryReviewResult({ validation });
  const serialized = JSON.stringify({ status, validation, review });

  assert.equal(status.step, "Step 160: Admin trading lab mock trading run summary review result recording gate");
  assert.equal(status.status, "admin_only_trading_lab_mock_trading_run_summary_review_result_fail_closed");
  assert.equal(status.mockTradingRunSummaryReviewResultModel.sourceStep, "step160");
  assert.equal(status.mockTradingRunSummaryReviewReceiptSchema.sourceStep, "step160");
  assert.equal(status.mockTradingRunSummaryReviewDecisionSummaryModel.sourceStep, "step160");
  assert.equal(status.mockTradingRunSummaryReviewSectionSummaryModel.sourceStep, "step160");
  assert.equal(status.reviewResult.reviewStatus, "recorded");
  assert.equal(status.reviewResult.decision, "mock_trading_run_summary_review_recorded");
  assert.equal(status.receipt.redacted, true);
  assert.equal(status.receipt.nextAllowedStep, "mock_trading_run_summary_core");
  assert.equal(status.sectionReviewSummary.redacted, true);
  assert.equal(status.sectionReviewSummary.strategySummaryReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.orderSummaryReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.executionSummaryReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.fillSummaryReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.ledgerSummaryReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.performanceSummaryReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.riskSummaryReviewStatus, "reviewed");
  assert.equal(status.decisionSummary.externalOrderAuthorityRequired, true);
  assert.equal(status.decisionSummary.realTradingRunSummaryStored, false);
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
  assert.equal(status.readyForOrderSubmission, false);
  ...
  assert.equal(status.networkCallAttempted, false);
  assert.equal(status.orderSubmissionAttempted, false);
  assert.equal(status.orderCandidateCreated, false);
  assert.equal(status.orderDraftCreated, false);
  assert.equal(status.kisOrderPayloadCreated, false);
  assert.equal(status.kisExecutionPayloadCreated, false);
  assert.equal(status.kisFillPayloadCreated, false);
  assert.equal(status.executionRecordCreated, false);
  assert.equal(status.fillRecordCreated, false);
  assert.equal(status.realTradingRunIdentifierCreated, false);
  assert.equal(status.realOrderIdentifierCreated, false);
  assert.equal(status.realExecutionIdentifierCreated, false);
  assert.equal(status.realFillIdentifierCreated, false);
  assert.equal(status.portfolioLedgerPersisted, false);
  assert.equal(status.performanceRecordPersisted, false);
  assert.equal(status.actualPerformanceRecordUpdated, false);
  assert.equal(status.actualCashUpdated, false);
  assert.equal(status.actualPositionUpdated, false);
  assert.equal(status.accountBalanceQueried, false);
  ...
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.persistentDbWriteRequired, false);
  assert.equal(status.boundaries.tradingRunSummaryPersistenceAllowed, false);
  assert.equal(validation.reviewStatus, "recorded");
  assert.equal(review.receipt.reviewStatus, "recorded");
  assert.equal(serialized.includes("providerCallsAllowed\":true"), false);
  assert.equal(serialized.includes("orderSubmissionAllowed\":true"), false);
  assert.equal(serialized.includes("readyForReadOnlyProviderCalls\":true"), false);
  assert.equal(serialized.includes("readyForOrderSubmission\":true"), false);
...
test("Step 160 admin mock trading run summary review result blocks missing or unsafe Step159 dependency", () => {
  const missingValidation = validateTradingLabMockTradingRunSummaryReviewResult({
    mockTradingRunSummaryPreflightStatus: null,
  });
  const unsafeValidation = validateTradingLabMockTradingRunSummaryReviewResult({
    preflightResult: {
      ...buildAdminTradingLabMockTradingRunSummaryPreflightStatus().result,
      redacted: false,
      scope: "live",
      readinessImpact: "ready",
      providerCallImpact: "allowed",
      ...
      liveTradingImpact: "ready",
      status: "blocked",
      realTradingRunIdentifier: "private",
    },
    summaryInputBundle: {
      ...buildTradingLabMockTradingRunSummaryInputBundle(),
      redacted: false,
  ...
  const warningValidation = validateTradingLabMockTradingRunSummaryReviewResult({
    preflightResult: {
      ...buildAdminTradingLabMockTradingRunSummaryPreflightStatus().result,
      status: "validation_required",
    },
  ...
  assert.equal(missingValidation.reviewStatus, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_trading_run_summary_preflight_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_trading_run_summary_preflight_result_missing"));
  assert.equal(unsafeValidation.reviewStatus, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_preflight_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_preflight_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_input_bundle_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_input_bundle_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_must_not_create_order_artifacts"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_must_not_create_execution_or_fill_records"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_must_not_persist_ledger_or_performance"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_must_not_write_db"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_must_not_query_or_mutate_account_state"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_must_not_create_kis_payloads"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_readiness_impact_not_none"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_provider_call_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_order_submission_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("summary_review_live_trading_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_preflight_blocked"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_actual_or_private_identifier_rejected"));
  assert.equal(warningValidation.reviewStatus, "validation_required");
  assert.ok(warningValidation.warnings.includes("mock_trading_run_summary_preflight_validation_required"));
});

test("Step 160 admin mock trading run summary review result dashboard integration keeps prior mock chain fail-closed", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.mockTradingRunSummaryReviewResultStatus;
  const serialized = JSON.stringify(dashboard);

  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.step, "Step 160: Admin trading lab mock trading run summary review result recording gate");
  assert.equal(status.receipt.nextAllowedStep, "mock_trading_run_summary_core");
  assert.equal(dashboard.mockTradingRunSummaryPreflightStatus.step, "Step 159: Admin trading lab mock trading run summary preflight");
  assert.equal(dashboard.mockTradingRunSummaryReviewResultModel.sourceStep, "step160");
  assert.equal(dashboard.mockTradingRunSummaryReviewReceiptSchema.sourceStep, "step160");
  assert.equal(dashboard.mockTradingRunSummaryReviewDecisionSummaryModel.sourceStep, "step160");
  assert.equal(dashboard.mockTradingRunSummaryReviewSectionSummaryModel.sourceStep, "step160");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
...
test("Step 161 admin mock trading run summary core builds deterministic redacted summary without side effects", () => {
  const status = buildAdminTradingLabMockTradingRunSummaryCoreStatus();
  const result = status.result;
  const validation = status.validation;
  const serialized = JSON.stringify(status);

  assert.equal(status.step, "Step 161: Admin trading lab mock trading run summary core");
  assert.equal(status.status, "admin_only_trading_lab_mock_trading_run_summary_core_fail_closed");
  assert.equal(status.mockTradingRunSummaryCoreModel.sourceStep, "step161");
  assert.equal(status.mockTradingRunSummaryResultModel.sourceStep, "step161");
  assert.equal(status.mockStrategySummaryResultModel.sourceStep, "step161");
  assert.equal(status.mockOrderExecutionFillSummaryResultModel.sourceStep, "step161");
  assert.equal(status.mockLedgerSummaryResultModel.sourceStep, "step161");
  assert.equal(status.mockPerformanceSummaryResultModel.sourceStep, "step161");
  assert.equal(status.mockRiskSafetySummaryResultModel.sourceStep, "step161");
  assert.equal(status.mockDashboardAggregationResultModel.sourceStep, "step161");
  assert.equal(status.mockChartAggregationResultModel.sourceStep, "step161");
  assert.equal(status.mockTradingRunSummaryResultSchema.sourceStep, "step161");
  assert.equal(result.scope, "mock_only");
  assert.equal(result.redacted, true);
  assert.equal(result.summaryStatus, "mock_summary_calculated");
  assert.equal(result.deterministic, true);
  assert.equal(result.nextAllowedStep, "mock_trading_run_dashboard_cleanup_preflight");
  assert.equal(status.dashboardAggregation.status, "calculated");
  assert.equal(status.dashboardAggregation.deterministic, true);
  assert.equal(status.dashboardAggregation.redacted, true);
  assert.equal(status.chartAggregation.status, "calculated");
  assert.equal(status.chartAggregation.deterministic, true);
  assert.equal(status.chartAggregation.redacted, true);
  assert.equal(validation.summaryStatus, "mock_summary_calculated");
  assert.equal(validation.deterministicAggregationStatus, "deterministic");
  assert.equal(status.flags.providerCallsAllowed, false);
  assert.equal(status.flags.orderSubmissionAllowed, false);
  assert.equal(status.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(status.flags.readyForOrderSubmission, false);
  ...
  assert.equal(status.orderCandidateCreated, false);
  assert.equal(status.orderDraftCreated, false);
  assert.equal(status.orderPayloadCreated, false);
  assert.equal(status.kisOrderPayloadCreated, false);
  assert.equal(status.kisExecutionPayloadCreated, false);
  assert.equal(status.kisFillPayloadCreated, false);
  assert.equal(status.executionRecordCreated, false);
  ...
  assert.equal(status.persistentStorageUsed, false);
  assert.equal(status.dbWriteUsed, false);
  assert.equal(status.actualInvestmentPerformanceConfirmed, false);
  assert.equal(status.returnGuaranteeProvided, false);
  assert.equal(status.investmentAdviceProvided, false);
  assert.equal(status.boundaries.adminOnly, true);
  assert.equal(status.boundaries.publicDashboardExposed, false);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
...
test("Step 161 admin mock trading run summary core blocks missing unsafe or incomplete Step160 dependency", () => {
  const missingValidation = validateTradingLabMockTradingRunSummaryCore({
    mockTradingRunSummaryReviewResultStatus: null,
  });
  const unsafeValidation = validateTradingLabMockTradingRunSummaryCore({
    reviewResult: {
      ...buildAdminTradingLabMockTradingRunSummaryReviewResultStatus().reviewResult,
      redacted: false,
      reviewStatus: "blocked",
      readinessImpact: "ready",
      providerCallImpact: "allowed",
    ...
    reviewReceipt: {
      ...buildAdminTradingLabMockTradingRunSummaryReviewResultStatus().receipt,
      redacted: false,
      nextAllowedStep: "live_order_submission",
    },
    reviewSectionSummary: {
      ...buildAdminTradingLabMockTradingRunSummaryReviewResultStatus().sectionReviewSummary,
      realTradingRunIdentifierCreated: true,
      actualPerformanceRecordStored: true,
      actualCashUpdated: true,
      actualPositionUpdated: true,
    },
    summaryInputBundle: {
  ...
  const warningValidation = validateTradingLabMockTradingRunSummaryCore({
  ...
  assert.equal(missingValidation.summaryStatus, "blocked");
  assert.ok(missingValidation.blockers.includes("mock_trading_run_summary_review_result_status_missing"));
  assert.ok(missingValidation.blockers.includes("mock_trading_run_summary_review_result_missing"));
  assert.equal(unsafeValidation.summaryStatus, "blocked");
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_review_result_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_review_result_not_recorded"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_review_receipt_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_core_not_allowed_by_step160"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_input_bundle_not_redacted"));
  assert.ok(unsafeValidation.blockers.includes("mock_trading_run_summary_input_bundle_scope_not_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_must_not_write_db"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_must_not_create_order_artifacts"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_must_not_create_execution_or_fill_records"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_must_not_persist_ledger_or_performance"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_must_not_query_or_mutate_account_state"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_must_not_create_kis_payloads"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_must_not_create_real_trading_run_identifier"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_must_not_store_performance_record"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_must_not_mutate_account_state"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_readiness_impact_not_none"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_provider_call_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_order_submission_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("summary_core_live_trading_impact_not_blocked"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_actual_or_private_identifier_rejected"));
  assert.equal(warningValidation.summaryStatus, "validation_required");
  assert.ok(warningValidation.warnings.includes("dashboard_aggregation_validation_required"));
  assert.ok(warningValidation.warnings.includes("chart_aggregation_validation_required"));
});

test("Step 161 admin mock trading run summary core dashboard integration keeps prior mock chain fail-closed", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.mockTradingRunSummaryCoreStatus;
  const serialized = JSON.stringify(dashboard);

  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.step, "Step 161: Admin trading lab mock trading run summary core");
  assert.equal(status.result.nextAllowedStep, "mock_trading_run_dashboard_cleanup_preflight");
  assert.equal(dashboard.mockTradingRunSummaryReviewResultStatus.step, "Step 160: Admin trading lab mock trading run summary review result recording gate");
  assert.equal(dashboard.mockTradingRunSummaryPreflightStatus.step, "Step 159: Admin trading lab mock trading run summary preflight");
  assert.equal(dashboard.mockTradingRunSummaryCoreModel.sourceStep, "step161");
  assert.equal(dashboard.mockTradingRunSummaryResultModel.sourceStep, "step161");
  assert.equal(dashboard.mockStrategySummaryResultModel.sourceStep, "step161");
  assert.equal(dashboard.mockOrderExecutionFillSummaryResultModel.sourceStep, "step161");
  assert.equal(dashboard.mockLedgerSummaryResultModel.sourceStep, "step161");
  assert.equal(dashboard.mockPerformanceSummaryResultModel.sourceStep, "step161");
  assert.equal(dashboard.mockRiskSafetySummaryResultModel.sourceStep, "step161");
  assert.equal(dashboard.mockDashboardAggregationResultModel.sourceStep, "step161");
  assert.equal(dashboard.mockChartAggregationResultModel.sourceStep, "step161");
  assert.equal(dashboard.mockTradingRunSummaryResultSchema.sourceStep, "step161");
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
  assert.equal(dashboard.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(dashboard.flags.readyForOrderSubmission, false);
...
test("Step 162 admin mock dashboard cleanup preflight builds summary-first redacted plan without side effects", () => {
  const status = buildAdminTradingLabMockDashboardCleanupPreflightStatus();
  const sectionInventory = buildTradingLabMockDashboardSectionInventory();
  const priorityLayout = buildTradingLabMockDashboardPriorityLayout();
  const collapsibleSectionPlan = buildTradingLabMockDashboardCollapsibleSectionPlan();
  const serialized = JSON.stringify(status);

  assert.equal(status.ok, true);
  assert.equal(status.step, "Step 162: Admin trading lab mock dashboard cleanup preflight");
  assert.equal(status.status, "admin_only_trading_lab_mock_dashboard_cleanup_preflight_fail_closed");
  assert.equal(status.mockDashboardCleanupPreflightModel.sourceStep, "step162");
  assert.equal(status.mockDashboardSectionInventoryModel.sourceStep, "step162");
  assert.equal(status.mockDashboardPriorityLayoutModel.sourceStep, "step162");
  assert.equal(status.mockDashboardCollapsibleSectionPlanModel.sourceStep, "step162");
  assert.equal(status.mockDashboardCleanupPreflightResultSchema.sourceStep, "step162");
  assert.equal(status.dependency.step161Required, true);
  assert.equal(status.result.status, "mock_dashboard_cleanup_ready");
  assert.equal(status.result.scope, "mock_only");
  assert.equal(status.result.redacted, true);
  assert.equal(status.result.readinessImpact, "none");
  assert.equal(status.result.providerCallImpact, "blocked");
  assert.equal(status.result.orderSubmissionImpact, "blocked");
  assert.equal(status.result.liveTradingImpact, "blocked");
  assert.equal(status.result.nextAllowedStep, "mock_dashboard_cleanup_review");
  assert.equal(status.sectionInventory.status, "mock_inventory_ready");
  assert.equal(status.sectionInventory.deterministic, true);
  assert.equal(status.sectionInventory.redacted, true);
  assert.equal(status.sectionInventory.duplicateSectionIds.length, 0);
  assert.equal(status.priorityLayout.priorityMode, "summary_first");
  assert.equal(status.priorityLayout.summaryFirstSectionId, "mock_trading_run_summary_result");
  assert.equal(status.priorityLayout.safetyPanelSeparated, true);
  assert.equal(status.collapsibleSectionPlan.status, "mock_collapsible_plan_ready");
  assert.equal(status.collapsibleSectionPlan.deletesExistingSections, false);
  assert.equal(status.boundaries.adminOnly, true);
  assert.equal(status.boundaries.publicDashboardExposed, false);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.existingSectionsDeleted, false);
  assert.equal(status.flags.providerCallsAllowed, false);
  assert.equal(status.flags.orderSubmissionAllowed, false);
  assert.equal(status.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(status.flags.readyForOrderSubmission, false);
  ...
  assert.equal(status.persistentStorageUsed, false);
  assert.equal(status.dbWriteUsed, false);
  assert.equal(sectionInventory.status, "mock_inventory_ready");
  assert.equal(priorityLayout.status, "mock_layout_ready");
  assert.equal(collapsibleSectionPlan.status, "mock_collapsible_plan_ready");
  assert.equal(serialized.includes("providerCallsAllowed\":true"), false);
  assert.equal(serialized.includes("orderSubmissionAllowed\":true"), false);
  assert.equal(serialized.includes("readyForReadOnlyProviderCalls\":true"), false);
  assert.equal(serialized.includes("readyForOrderSubmission\":true"), false);
  ...
  assert.equal(serialized.includes("executionRecordCreated\":true"), false);
  assert.equal(serialized.includes("fillRecordCreated\":true"), false);
  assert.equal(serialized.includes("realTradingRunIdentifierCreated\":true"), false);
  assert.equal(serialized.includes("persistentStorageUsed\":true"), false);
  assert.equal(serialized.includes("dbWriteUsed\":true"), false);
  assert.equal(serialized.includes("credential\":\""), false);
  assert.equal(serialized.includes("accountIdentifier\":\""), false);
...
test("Step 162 admin mock dashboard cleanup preflight blocks unsafe dependencies and invalid plans", () => {
  const unsafeStep161 = buildAdminTradingLabMockTradingRunSummaryCoreStatus();
  const missingValidation = validateTradingLabMockDashboardCleanupPreflight({
    mockTradingRunSummaryCoreStatus: {},
    summaryResult: {},
  });
  const unsafeValidation = validateTradingLabMockDashboardCleanupPreflight({
    mockTradingRunSummaryCoreStatus: unsafeStep161,
    summaryResult: {
      ...unsafeStep161.result,
      redacted: false,
      scope: "live",
      readinessImpact: "ready",
      providerCallImpact: "allowed",
    ...
    sectionInventory: buildTradingLabMockDashboardSectionInventory({
      sections: [
        { sectionId: "duplicate", priority: "primary", redacted: true },
        { sectionId: "duplicate", priority: "detail", redacted: true },
      ],
    }),
    priorityLayout: buildTradingLabMockDashboardPriorityLayout({
      primaryOrder: ["mock_kpi_cards"],
      safetyPanelSeparated: false,
    }),
    collapsibleSectionPlan: buildTradingLabMockDashboardCollapsibleSectionPlan({
      deterministic: false,
      groups: [],
    }),
  });
  const warningValidation = validateTradingLabMockDashboardCleanupPreflight({
    sectionInventory: buildTradingLabMockDashboardSectionInventory({
      sections: [
        { sectionId: "mock_trading_run_summary_result", priority: "primary", redacted: true },
      ],
    }),
    collapsibleSectionPlan: buildTradingLabMockDashboardCollapsibleSectionPlan({
      groups: [
        { groupId: "single_group", defaultCollapsed: true, redacted: true },
      ],
    }),
  });

  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("step161_summary_result_must_be_redacted"));
  assert.ok(missingValidation.blockers.includes("step161_summary_scope_must_be_mock_only"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("step161_summary_result_must_be_redacted"));
  assert.ok(unsafeValidation.blockers.includes("step161_summary_scope_must_be_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("readiness_impact_must_remain_none"));
  assert.ok(unsafeValidation.blockers.includes("provider_call_impact_must_remain_blocked"));
  assert.ok(unsafeValidation.blockers.includes("order_submission_impact_must_remain_blocked"));
  assert.ok(unsafeValidation.blockers.includes("live_trading_impact_must_remain_blocked"));
  assert.ok(unsafeValidation.blockers.includes("dashboard_section_inventory_must_not_have_duplicate_ids"));
  assert.ok(unsafeValidation.blockers.includes("summary_result_must_be_first"));
  assert.ok(unsafeValidation.blockers.includes("safety_panel_must_remain_separated"));
  assert.ok(unsafeValidation.blockers.includes("collapsible_plan_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_actual_or_private_identifier_rejected"));
  assert.equal(warningValidation.status, "validation_required");
  assert.ok(warningValidation.warnings.includes("summary_first_primary_sections_required"));
  assert.ok(warningValidation.warnings.includes("mock_detail_sections_should_be_grouped"));
  assert.ok(warningValidation.warnings.includes("collapsible_detail_groups_required"));
});

test("Step 162 admin mock dashboard cleanup preflight dashboard integration preserves prior mock chain", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.mockDashboardCleanupPreflightStatus;
  const serialized = JSON.stringify(dashboard);

  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.step, "Step 162: Admin trading lab mock dashboard cleanup preflight");
  assert.equal(dashboard.mockTradingRunSummaryCoreStatus.step, "Step 161: Admin trading lab mock trading run summary core");
  assert.equal(dashboard.mockTradingRunSummaryReviewResultStatus.step, "Step 160: Admin trading lab mock trading run summary review result recording gate");
  assert.equal(dashboard.mockTradingRunSummaryPreflightStatus.step, "Step 159: Admin trading lab mock trading run summary preflight");
  assert.equal(dashboard.mockDashboardCleanupPreflightModel.sourceStep, "step162");
  assert.equal(dashboard.mockDashboardSectionInventoryModel.sourceStep, "step162");
  assert.equal(dashboard.mockDashboardPriorityLayoutModel.sourceStep, "step162");
  assert.equal(dashboard.mockDashboardCollapsibleSectionPlanModel.sourceStep, "step162");
  assert.equal(dashboard.mockDashboardCleanupPreflightResultSchema.sourceStep, "step162");
  assert.equal(status.result.status, "mock_dashboard_cleanup_ready");
  assert.equal(status.result.readinessImpact, "none");
  assert.equal(status.result.providerCallImpact, "blocked");
  assert.equal(status.result.orderSubmissionImpact, "blocked");
  assert.equal(status.result.liveTradingImpact, "blocked");
  assert.equal(status.sectionInventory.sections.some((section) => section.sectionId === "mock_trading_run_summary_result"), true);
  assert.equal(status.priorityLayout.summaryFirstSectionId, "mock_trading_run_summary_result");
  assert.equal(status.collapsibleSectionPlan.deletesExistingSections, false);
  assert.equal(dashboard.flags.providerCallsAllowed, false);
  assert.equal(dashboard.flags.orderSubmissionAllowed, false);
...
test("Step 163 admin mock dashboard cleanup review result records redacted receipt without side effects", () => {
  const status = buildAdminTradingLabMockDashboardCleanupReviewResultStatus();
  const gate = buildTradingLabMockDashboardCleanupReviewResultRecordingGate();
  const sectionSummary = buildTradingLabMockDashboardCleanupReviewSectionSummary();
  const decisionSummary = buildTradingLabMockDashboardCleanupReviewDecisionSummary();
  const serialized = JSON.stringify(status);

  assert.equal(status.ok, true);
  assert.equal(status.step, "Step 163: Admin trading lab mock dashboard cleanup review result recording gate");
  assert.equal(status.status, "admin_only_trading_lab_mock_dashboard_cleanup_review_result_fail_closed");
  assert.equal(status.mockDashboardCleanupReviewResultModel.sourceStep, "step163");
  assert.equal(status.mockDashboardCleanupReviewReceiptSchema.sourceStep, "step163");
  assert.equal(status.mockDashboardCleanupReviewDecisionSummaryModel.sourceStep, "step163");
  assert.equal(status.mockDashboardCleanupReviewSectionSummaryModel.sourceStep, "step163");
  assert.equal(status.dependency.step162Required, true);
  assert.equal(status.reviewResult.reviewStatus, "recorded");
  assert.equal(status.reviewResult.decision, "mock_dashboard_cleanup_review_recorded");
  assert.equal(status.reviewResult.redacted, true);
  assert.equal(status.receipt.redacted, true);
  assert.equal(status.receipt.nextAllowedStep, "mock_dashboard_cleanup_core");
  assert.equal(status.receipt.readinessImpact, "none");
  assert.equal(status.receipt.providerCallImpact, "blocked");
  assert.equal(status.receipt.orderSubmissionImpact, "blocked");
  assert.equal(status.receipt.liveTradingImpact, "blocked");
  assert.equal(status.sectionReviewSummary.sectionInventoryReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.priorityLayoutReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.collapsibleSectionPlanReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.summaryFirstLayoutReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.safetyPanelSeparationReviewStatus, "reviewed");
  assert.equal(status.sectionReviewSummary.sourceAlignmentReviewStatus, "reviewed");
  assert.equal(gate.reviewResult.reviewStatus, "recorded");
  assert.equal(sectionSummary.redacted, true);
  assert.equal(decisionSummary.decision, "mock_dashboard_cleanup_review_recorded");
  assert.equal(status.flags.providerCallsAllowed, false);
  assert.equal(status.flags.orderSubmissionAllowed, false);
  assert.equal(status.flags.readyForReadOnlyProviderCalls, false);
  assert.equal(status.flags.readyForOrderSubmission, false);
  ...
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.realTradingRunIdentifierAllowed, false);
  assert.equal(status.boundaries.realPerformanceRecordAllowed, false);
  assert.equal(status.boundaries.dashboardCleanupReviewPersistenceAllowed, false);
  assert.equal(serialized.includes("providerCallsAllowed\":true"), false);
  assert.equal(serialized.includes("orderSubmissionAllowed\":true"), false);
  assert.equal(serialized.includes("readyForReadOnlyProviderCalls\":true"), false);
  assert.equal(serialized.includes("readyForOrderSubmission\":true"), false);
  ...
  assert.equal(serialized.includes("hash\":\""), false);
  assert.equal(serialized.includes("digest\":\""), false);
  assert.equal(serialized.includes("actualTradingRunId\":\""), false);
  assert.equal(serialized.includes("actualOrderId\":\""), false);
  assert.equal(serialized.includes("actualExecutionId\":\""), false);
  assert.equal(serialized.includes("actualFillId\":\""), false);
});

test("Step 163 admin mock dashboard cleanup review result blocks unsafe Step162 dependency", () => {
  const safePreflight = buildAdminTradingLabMockDashboardCleanupPreflightStatus();
  const missingValidation = validateTradingLabMockDashboardCleanupReviewResult({
    mockDashboardCleanupPreflightStatus: {},
    preflightResult: {},
  });
  const unsafeValidation = validateTradingLabMockDashboardCleanupReviewResult({
    mockDashboardCleanupPreflightStatus: safePreflight,
    preflightResult: {
      ...safePreflight.result,
      redacted: false,
      scope: "live",
      readinessImpact: "ready",
      providerCallImpact: "allowed",
    ...
    sectionInventory: {
      ...safePreflight.sectionInventory,
      deterministic: false,
    },
    priorityLayout: {
      ...safePreflight.priorityLayout,
      deterministic: false,
      priorityMode: "detail_first",
      safetyPanelSeparated: false,
    },
    collapsibleSectionPlan: {
      ...safePreflight.collapsibleSectionPlan,
      deterministic: false,
      deletesExistingSections: true,
    },
  });
  const warningValidation = validateTradingLabMockDashboardCleanupReviewResult({
    mockDashboardCleanupPreflightStatus: {
      ...safePreflight,
      result: {
        ...safePreflight.result,
  ...
  assert.equal(missingValidation.reviewStatus, "blocked");
  assert.ok(missingValidation.blockers.includes("step162_dashboard_cleanup_preflight_result_must_be_redacted"));
  assert.ok(missingValidation.blockers.includes("step162_dashboard_cleanup_preflight_scope_must_be_mock_only"));
  assert.equal(unsafeValidation.reviewStatus, "blocked");
  assert.ok(unsafeValidation.blockers.includes("step162_dashboard_cleanup_preflight_result_must_be_redacted"));
  assert.ok(unsafeValidation.blockers.includes("step162_dashboard_cleanup_preflight_scope_must_be_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("readiness_impact_must_remain_none"));
  assert.ok(unsafeValidation.blockers.includes("provider_call_impact_must_remain_blocked"));
  assert.ok(unsafeValidation.blockers.includes("order_submission_impact_must_remain_blocked"));
  assert.ok(unsafeValidation.blockers.includes("live_trading_impact_must_remain_blocked"));
  assert.ok(unsafeValidation.blockers.includes("section_inventory_review_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("priority_layout_review_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("collapsible_plan_review_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("summary_first_layout_must_be_preserved"));
  assert.ok(unsafeValidation.blockers.includes("safety_panel_must_remain_separated"));
  assert.ok(unsafeValidation.blockers.includes("review_must_not_delete_existing_sections"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_actual_or_private_identifier_rejected"));
  assert.equal(warningValidation.reviewStatus, "validation_required");
  assert.ok(warningValidation.warnings.includes("step162_dashboard_cleanup_preflight_not_ready"));
});

test("Step 163 admin mock dashboard cleanup review result dashboard integration keeps prior mock chain", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.mockDashboardCleanupReviewResultStatus;
  const serialized = JSON.stringify(dashboard);

  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.step, "Step 163: Admin trading lab mock dashboard cleanup review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupPreflightStatus.step, "Step 162: Admin trading lab mock dashboard cleanup preflight");
  assert.equal(dashboard.mockTradingRunSummaryCoreStatus.step, "Step 161: Admin trading lab mock trading run summary core");
  assert.equal(dashboard.mockDashboardCleanupReviewResultModel.sourceStep, "step163");
  assert.equal(dashboard.mockDashboardCleanupReviewReceiptSchema.sourceStep, "step163");
  assert.equal(dashboard.mockDashboardCleanupReviewDecisionSummaryModel.sourceStep, "step163");
  assert.equal(dashboard.mockDashboardCleanupReviewSectionSummaryModel.sourceStep, "step163");
  assert.equal(status.receipt.nextAllowedStep, "mock_dashboard_cleanup_core");
  assert.equal(status.receipt.readinessImpact, "none");
  assert.equal(status.receipt.providerCallImpact, "blocked");
  assert.equal(status.receipt.orderSubmissionImpact, "blocked");
...
test("Step 164 admin mock dashboard cleanup core builds summary-first redacted layout without side effects", () => {
  const status = buildAdminTradingLabMockDashboardCleanupCoreStatus();
  const core = buildTradingLabMockDashboardCleanupCore();
  const summaryFirstLayout = buildTradingLabMockDashboardSummaryFirstLayoutResult();
  const collapsibleGroups = buildTradingLabMockDashboardCollapsibleDetailGroupResult();
  const validation = validateTradingLabMockDashboardCleanupCore();
  const serialized = JSON.stringify(status);

  assert.equal(status.ok, true);
  assert.equal(status.step, "Step 164: Admin trading lab mock dashboard cleanup core");
  assert.equal(status.status, "admin_only_trading_lab_mock_dashboard_cleanup_core_fail_closed");
  assert.equal(status.mockDashboardCleanupCoreModel.sourceStep, "step164");
  assert.equal(status.mockDashboardCleanupResultModel.sourceStep, "step164");
  assert.equal(status.mockDashboardSummaryFirstLayoutResultModel.sourceStep, "step164");
  assert.equal(status.mockDashboardCollapsibleDetailGroupResultModel.sourceStep, "step164");
  assert.equal(status.mockDashboardCleanupResultSchema.sourceStep, "step164");
  assert.equal(status.dependency.step163Required, true);
  assert.equal(status.dependency.reviewStatus, "recorded");
  assert.equal(status.result.dashboardCleanupResultId, "step164_mock_dashboard_cleanup_result");
  assert.equal(status.result.scope, "mock_only");
  assert.equal(status.result.cleanupStatus, "mock_dashboard_cleanup_applied");
  assert.equal(status.result.redacted, true);
  assert.equal(status.result.deterministic, true);
  assert.equal(status.result.summaryFirstLayout.summaryFirst, true);
  assert.equal(status.result.kpiSourceAlignment, "aligned");
  assert.equal(status.result.chartSourceAlignment, "aligned");
  assert.equal(status.result.allocationSourceAlignment, "aligned");
  assert.equal(status.result.safetyPanelSeparationStatus, "separated");
  assert.equal(status.result.dangerousActionLabelStatus, "absent");
  assert.equal(status.result.readinessImpact, "none");
  assert.equal(status.result.providerCallImpact, "blocked");
  assert.equal(status.result.orderSubmissionImpact, "blocked");
  assert.equal(status.result.liveTradingImpact, "blocked");
  assert.equal(status.result.nextAllowedStep, "mock_dashboard_cleanup_core_review");
  assert.equal(core.result.cleanupStatus, "mock_dashboard_cleanup_applied");
  assert.equal(summaryFirstLayout.status, "applied");
  assert.equal(summaryFirstLayout.summaryFirst, true);
  assert.equal(summaryFirstLayout.redacted, true);
  assert.equal(summaryFirstLayout.deterministic, true);
  assert.equal(collapsibleGroups.status, "applied");
  assert.equal(collapsibleGroups.defaultCollapsed, true);
  assert.equal(collapsibleGroups.deletesExistingSections, false);
  assert.equal(collapsibleGroups.safetyPanelSeparated, true);
  assert.ok(collapsibleGroups.groups.some((group) => group.groupId === "mock_dashboard_cleanup_chain"));
  assert.equal(validation.cleanupStatus, "mock_dashboard_cleanup_applied");
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
  assert.equal(status.readyForOrderSubmission, false);
  ...
  assert.equal(status.persistentStorageUsed, false);
  assert.equal(status.dbWriteUsed, false);
  assert.equal(status.dashboardCleanupCoreExecuted, false);
  assert.equal(status.existingSectionsDeleted, false);
  assert.equal(status.boundaries.adminOnly, true);
  assert.equal(status.boundaries.publicDashboardExposed, false);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.dashboardCleanupCorePersistenceAllowed, false);
  assert.equal(serialized.includes("providerCallsAllowed\":true"), false);
  assert.equal(serialized.includes("orderSubmissionAllowed\":true"), false);
  assert.equal(serialized.includes("readyForReadOnlyProviderCalls\":true"), false);
  assert.equal(serialized.includes("readyForOrderSubmission\":true"), false);
...
test("Step 164 admin mock dashboard cleanup core blocks unsafe Step163 dependency and invalid layout", () => {
  const missingValidation = validateTradingLabMockDashboardCleanupCore({
    mockDashboardCleanupReviewResultStatus: {},
    reviewResult: {},
    receipt: {},
  });
  const unsafeValidation = validateTradingLabMockDashboardCleanupCore({
    reviewResult: {
      dashboardCleanupReviewResultId: "unsafe_step163",
      reviewStatus: "recorded",
      redacted: false,
      readinessImpact: "none",
      providerCallImpact: "blocked",
  ...
  assert.equal(missingValidation.cleanupStatus, "blocked");
  assert.ok(missingValidation.blockers.includes("step163_dashboard_cleanup_review_result_required"));
  assert.equal(unsafeValidation.cleanupStatus, "blocked");
  assert.ok(unsafeValidation.blockers.includes("step163_dashboard_cleanup_review_result_must_be_redacted"));
  assert.ok(unsafeValidation.blockers.includes("step163_receipt_must_be_redacted"));
  assert.ok(unsafeValidation.blockers.includes("summary_first_layout_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("summary_first_layout_must_be_applied"));
  assert.ok(unsafeValidation.blockers.includes("collapsible_detail_groups_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("detail_groups_must_default_collapsed"));
  assert.ok(unsafeValidation.blockers.includes("cleanup_core_must_not_delete_existing_sections"));
  assert.ok(unsafeValidation.blockers.includes("safety_panel_must_remain_separated"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_actual_or_private_identifier_rejected"));
});

test("Step 164 admin mock dashboard cleanup core dashboard integration keeps prior mock chain", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.mockDashboardCleanupCoreStatus;
  const serialized = JSON.stringify(dashboard);

  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.step, "Step 164: Admin trading lab mock dashboard cleanup core");
  assert.equal(dashboard.mockDashboardCleanupReviewResultStatus.step, "Step 163: Admin trading lab mock dashboard cleanup review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupPreflightStatus.step, "Step 162: Admin trading lab mock dashboard cleanup preflight");
  assert.equal(dashboard.mockTradingRunSummaryCoreStatus.step, "Step 161: Admin trading lab mock trading run summary core");
  assert.equal(dashboard.mockDashboardCleanupCoreModel.sourceStep, "step164");
  assert.equal(dashboard.mockDashboardCleanupResultModel.sourceStep, "step164");
  assert.equal(dashboard.mockDashboardSummaryFirstLayoutResultModel.sourceStep, "step164");
  assert.equal(dashboard.mockDashboardCollapsibleDetailGroupResultModel.sourceStep, "step164");
  assert.equal(dashboard.mockDashboardCleanupResultSchema.sourceStep, "step164");
  assert.equal(status.result.cleanupStatus, "mock_dashboard_cleanup_applied");
  assert.equal(status.result.summaryFirstLayout.summaryFirst, true);
  assert.equal(status.result.safetyPanelSeparationStatus, "separated");
  assert.equal(status.result.dangerousActionLabelStatus, "absent");
  ...
  assert.equal(status.result.orderSubmissionImpact, "blocked");
  assert.equal(status.result.liveTradingImpact, "blocked");
  assert.ok(status.result.visiblePrimarySections.includes("overview"));
  assert.ok(status.result.visibleDetailGroups.includes("mock_dashboard_cleanup_chain"));
  assert.equal(status.boundaries.publicDashboardExposed, false);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(dashboard.flags.providerCallsAllowed, false);
...
test("Step 165 admin mock dashboard cleanup core review result records redacted receipt without side effects", () => {
  const status = buildAdminTradingLabMockDashboardCleanupCoreReviewResultStatus();
  const review = buildTradingLabMockDashboardCleanupCoreReviewResult();
  const reviewSummary = buildTradingLabMockDashboardCleanupCoreReviewSummary();
  const validation = validateTradingLabMockDashboardCleanupCoreReviewResult();
  const serialized = JSON.stringify(status);

  assert.equal(status.ok, true);
  assert.equal(status.step, "Step 165: Admin trading lab mock dashboard cleanup core review result recording gate");
  assert.equal(status.status, "admin_only_trading_lab_mock_dashboard_cleanup_core_review_result_fail_closed");
  assert.equal(status.mockDashboardCleanupCoreReviewResultModel.sourceStep, "step165");
  assert.equal(status.mockDashboardCleanupCoreReviewReceiptSchema.sourceStep, "step165");
  assert.equal(status.mockDashboardCleanupCoreReviewDecisionSummaryModel.sourceStep, "step165");
  assert.equal(status.mockDashboardCleanupCoreReviewSummaryModel.sourceStep, "step165");
  assert.equal(status.dependency.step164Required, true);
  assert.equal(status.dependency.cleanupStatus, "mock_dashboard_cleanup_applied");
  assert.equal(status.reviewResult.reviewStatus, "recorded");
  assert.equal(status.reviewResult.decision, "mock_dashboard_cleanup_core_review_recorded");
  assert.equal(status.reviewResult.redacted, true);
  assert.equal(status.reviewResult.readinessImpact, "none");
  assert.equal(status.reviewResult.providerCallImpact, "blocked");
  assert.equal(status.reviewResult.orderSubmissionImpact, "blocked");
  assert.equal(status.reviewResult.liveTradingImpact, "blocked");
  assert.equal(status.receipt.receiptId, "step165_mock_dashboard_cleanup_core_review_receipt");
  assert.equal(status.receipt.redacted, true);
  assert.equal(status.receipt.nextAllowedStep, "mock_trading_lab_dashboard_ux_polish_preflight");
  assert.equal(status.receipt.summaryFirstLayoutReviewStatus, "reviewed");
  assert.equal(status.receipt.kpiSourceAlignmentReviewStatus, "reviewed");
  assert.equal(status.receipt.chartSourceAlignmentReviewStatus, "reviewed");
  assert.equal(status.receipt.allocationSourceAlignmentReviewStatus, "reviewed");
  assert.equal(status.receipt.collapsibleGroupReviewStatus, "reviewed");
  assert.equal(status.receipt.safetyPanelSeparationReviewStatus, "reviewed");
  assert.equal(status.receipt.dangerousActionLabelReviewStatus, "reviewed");
  assert.equal(review.reviewResult.reviewStatus, "recorded");
  assert.equal(reviewSummary.summaryFirstLayoutReviewStatus, "reviewed");
  assert.equal(validation.reviewStatus, "recorded");
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
...
test("Step 165 admin mock dashboard cleanup core review result blocks missing or unsafe Step164 dependency", () => {
  const missingValidation = validateTradingLabMockDashboardCleanupCoreReviewResult({
    mockDashboardCleanupCoreStatus: {},
    cleanupResult: {},
  });
  const unsafeValidation = validateTradingLabMockDashboardCleanupCoreReviewResult({
    cleanupResult: {
      dashboardCleanupResultId: "unsafe_step164",
      scope: "live",
      cleanupStatus: "mock_dashboard_cleanup_applied",
      redacted: false,
      readinessImpact: "none",
      providerCallImpact: "blocked",
      orderSubmissionImpact: "blocked",
  ...
  assert.equal(missingValidation.reviewStatus, "blocked");
  assert.ok(missingValidation.blockers.includes("step164_dashboard_cleanup_result_required"));
  assert.equal(unsafeValidation.reviewStatus, "blocked");
  assert.ok(unsafeValidation.blockers.includes("step164_dashboard_cleanup_result_must_be_redacted"));
  assert.ok(unsafeValidation.blockers.includes("step164_cleanup_scope_must_be_mock_only"));
  assert.ok(unsafeValidation.blockers.includes("summary_first_layout_review_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("kpi_source_alignment_must_be_mock_aligned"));
  assert.ok(unsafeValidation.blockers.includes("collapsible_group_review_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("collapsible_groups_must_default_collapsed"));
  assert.ok(unsafeValidation.blockers.includes("dashboard_cleanup_review_must_not_delete_sections"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_actual_or_private_identifier_rejected"));
  assert.ok(unsafeValidation.blockers.includes("side_effects_must_remain_false"));
});

test("Step 165 admin mock dashboard cleanup core review result dashboard integration keeps prior mock chain", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.mockDashboardCleanupCoreReviewResultStatus;
  const serialized = JSON.stringify(dashboard);

  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.step, "Step 165: Admin trading lab mock dashboard cleanup core review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupCoreStatus.step, "Step 164: Admin trading lab mock dashboard cleanup core");
  assert.equal(dashboard.mockDashboardCleanupReviewResultStatus.step, "Step 163: Admin trading lab mock dashboard cleanup review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupPreflightStatus.step, "Step 162: Admin trading lab mock dashboard cleanup preflight");
  assert.equal(dashboard.mockTradingRunSummaryCoreStatus.step, "Step 161: Admin trading lab mock trading run summary core");
  assert.equal(dashboard.mockDashboardCleanupCoreReviewResultModel.sourceStep, "step165");
  assert.equal(dashboard.mockDashboardCleanupCoreReviewReceiptSchema.sourceStep, "step165");
  assert.equal(dashboard.mockDashboardCleanupCoreReviewDecisionSummaryModel.sourceStep, "step165");
  assert.equal(dashboard.mockDashboardCleanupCoreReviewSummaryModel.sourceStep, "step165");
  assert.equal(status.reviewResult.reviewStatus, "recorded");
  assert.equal(status.receipt.nextAllowedStep, "mock_trading_lab_dashboard_ux_polish_preflight");
  assert.equal(status.receipt.readinessImpact, "none");
  assert.equal(status.receipt.providerCallImpact, "blocked");
...
test("Step 167 admin trading lab dashboard UX polish preflight is redacted mock-only and side-effect free", () => {
  const step165Status = buildAdminTradingLabMockDashboardCleanupCoreReviewResultStatus();
  const step165Input = {
    mockDashboardCleanupCoreReviewResultStatus: step165Status,
    reviewResult: step165Status.reviewResult,
    receipt: step165Status.receipt,
  };
  const status = buildAdminTradingLabDashboardUxPolishPreflightStatus(step165Input);
  const result = buildTradingLabDashboardUxPolishPreflightResult(step165Input);
  const targets = buildTradingLabDashboardUxPolishTargetInventory(step165Input);
  const duplicateVerboseDetection = buildTradingLabDashboardUxPolishDuplicateVerboseDetection({ targetInventory: targets });
  const koreanLabels = buildTradingLabDashboardKoreanLabelPolishInventory();
  const validation = validateTradingLabDashboardUxPolishPreflight({
    ...step165Input,
    targetInventory: targets,
    duplicateVerboseDetection,
    koreanLabelInventory: koreanLabels,
  });
  const serialized = JSON.stringify(status);

  assert.equal(status.ok, true);
  assert.equal(status.step, "Step 167: Admin trading lab dashboard UX polish preflight");
  assert.equal(status.status, "admin_only_trading_lab_dashboard_ux_polish_preflight_fail_closed");
  assert.equal(status.dashboardUxPolishPreflightModel.sourceStep, "step167");
  assert.equal(status.uxPolishTargetInventoryModel.sourceStep, "step167");
  assert.equal(status.uxPolishDuplicateVerboseDetectionModel.sourceStep, "step167");
  assert.equal(status.uxPolishKoreanLabelInventoryModel.sourceStep, "step167");
  assert.equal(status.dashboardUxPolishPreflightResultSchema.sourceStep, "step167");
  assert.equal(status.dependency.step165Required, true);
  assert.equal(status.dependency.reviewStatus, "recorded");
  assert.equal(status.result.status, "mock_ux_polish_ready");
  assert.equal(status.result.scope, "mock_only");
  assert.equal(status.result.redacted, true);
  assert.equal(status.result.summaryReadabilityStatus, "ready");
  assert.equal(status.result.kpiReadabilityStatus, "ready");
  assert.equal(status.result.chartReadabilityStatus, "ready");
  assert.equal(status.result.allocationReadabilityStatus, "ready");
  assert.equal(status.result.collapsibleDefaultStatus, "ready");
  assert.equal(status.result.duplicateSectionStatus, "polish_recommended");
  assert.equal(status.result.verboseSectionStatus, "polish_recommended");
  assert.equal(status.result.koreanLabelStatus, "inventory_ready");
  assert.equal(status.result.safetyNoticeStatus, "visible");
  assert.equal(status.result.dangerousActionLabelStatus, "absent");
  assert.equal(status.result.readinessImpact, "none");
  assert.equal(status.result.providerCallImpact, "blocked");
  assert.equal(status.result.orderSubmissionImpact, "blocked");
  assert.equal(status.result.liveTradingImpact, "blocked");
  assert.equal(result.result.status, "mock_ux_polish_ready");
  assert.ok(targets.some((target) => target.targetGroup === "overview" && target.priority === "high"));
  assert.ok(targets.some((target) => target.targetGroup === "detail_chain" && target.defaultCollapsed === true));
  assert.equal(duplicateVerboseDetection.deterministic, true);
  assert.equal(duplicateVerboseDetection.detailChainDefaultCollapsed, true);
  assert.equal(koreanLabels.status, "inventory_ready");
  assert.ok(koreanLabels.mappings.length >= 10);
  assert.equal(validation.status, "mock_ux_polish_ready");
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
  assert.equal(status.readyForOrderSubmission, false);
  ...
  assert.equal(status.portfolioLedgerPersisted, false);
  assert.equal(status.performanceRecordPersisted, false);
  assert.equal(status.tradingRunSummaryPersisted, false);
  assert.equal(status.persistentStorageUsed, false);
  assert.equal(status.dbWriteUsed, false);
  assert.equal(status.dashboardUxPolishExecuted, false);
  assert.equal(status.dashboardSectionDeleted, false);
  assert.equal(status.myPageRouteChanged, false);
  assert.equal(status.accountSubscriptionBillingChanged, false);
  assert.equal(status.boundaries.adminOnly, true);
  assert.equal(status.boundaries.publicDashboardExposed, false);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.myPageRouteTouched, false);
  assert.equal(status.boundaries.accountSubscriptionBillingTouched, false);
  assert.equal(serialized.includes("providerCallsAllowed\":true"), false);
  assert.equal(serialized.includes("orderSubmissionAllowed\":true"), false);
  assert.equal(serialized.includes("readyForReadOnlyProviderCalls\":true"), false);
  assert.equal(serialized.includes("readyForOrderSubmission\":true"), false);
...
test("Step 167 admin trading lab dashboard UX polish preflight blocks missing or unsafe Step165 dependency", () => {
  const missingValidation = validateTradingLabDashboardUxPolishPreflight({
    mockDashboardCleanupCoreReviewResultStatus: {},
    reviewResult: {},
    receipt: {},
  });
  const unsafeValidation = validateTradingLabDashboardUxPolishPreflight({
    reviewResult: {
      dashboardCleanupCoreReviewResultId: "unsafe_step165",
      reviewStatus: "recorded",
      redacted: false,
      readinessImpact: "none",
      providerCallImpact: "blocked",
    ...
    receipt: {
      redacted: false,
      nextAllowedStep: "mock_trading_lab_dashboard_ux_polish_preflight",
      readinessImpact: "none",
      providerCallImpact: "blocked",
      orderSubmissionImpact: "blocked",
      liveTradingImpact: "blocked",
    ...
    duplicateVerboseDetection: {
      redacted: false,
      deterministic: false,
      detailChainDefaultCollapsed: false,
      noSectionDeletionPlanned: false,
    },
  ...
  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("step165_cleanup_core_review_result_required"));
  assert.ok(missingValidation.blockers.includes("step165_cleanup_core_review_receipt_required"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("step165_cleanup_core_review_result_must_be_redacted"));
  assert.ok(unsafeValidation.blockers.includes("step165_cleanup_core_review_receipt_must_be_redacted"));
  assert.ok(unsafeValidation.blockers.includes("ux_polish_target_inventory_must_be_redacted_step167"));
  assert.ok(unsafeValidation.blockers.includes("summary_first_overview_target_required"));
  assert.ok(unsafeValidation.blockers.includes("duplicate_verbose_detection_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("detail_chain_detection_must_default_collapsed"));
  assert.ok(unsafeValidation.blockers.includes("ux_polish_must_not_delete_sections"));
  assert.ok(unsafeValidation.blockers.includes("korean_label_inventory_must_be_ready_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("unsafe_actual_or_private_identifier_rejected"));
  assert.ok(unsafeValidation.blockers.includes("side_effects_must_remain_false"));
});

test("Step 167 admin trading lab dashboard integration preserves Step165 and Step166 mypage/account surfaces", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.dashboardUxPolishPreflightStatus;
  const serialized = JSON.stringify(dashboard);

  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.step, "Step 167: Admin trading lab dashboard UX polish preflight");
  assert.equal(dashboard.mockDashboardCleanupCoreReviewResultStatus.step, "Step 165: Admin trading lab mock dashboard cleanup core review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupCoreStatus.step, "Step 164: Admin trading lab mock dashboard cleanup core");
  assert.equal(dashboard.mockDashboardCleanupReviewResultStatus.step, "Step 163: Admin trading lab mock dashboard cleanup review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupPreflightStatus.step, "Step 162: Admin trading lab mock dashboard cleanup preflight");
  assert.equal(dashboard.mockTradingRunSummaryCoreStatus.step, "Step 161: Admin trading lab mock trading run summary core");
  assert.equal(dashboard.dashboardUxPolishPreflightModel.sourceStep, "step167");
  assert.equal(dashboard.uxPolishTargetInventoryModel.sourceStep, "step167");
  assert.equal(dashboard.uxPolishDuplicateVerboseDetectionModel.sourceStep, "step167");
  assert.equal(dashboard.uxPolishKoreanLabelInventoryModel.sourceStep, "step167");
  assert.equal(dashboard.dashboardUxPolishPreflightResultSchema.sourceStep, "step167");
  assert.equal(status.result.status, "mock_ux_polish_ready");
  assert.equal(status.result.nextAllowedStep, "mock_dashboard_ux_polish_review_result");
  assert.equal(status.boundaries.publicDashboardExposed, false);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.myPageRouteTouched, false);
...
test("Step 168 admin trading lab dashboard UX polish review result records redacted mock-only receipt without side effects", () => {
  const preflightStatus = buildAdminTradingLabDashboardUxPolishPreflightStatus();
  const step168Input = {
    dashboardUxPolishPreflightStatus: preflightStatus,
    preflightResult: preflightStatus.result,
  };
  const status = buildAdminTradingLabDashboardUxPolishReviewResultStatus(step168Input);
  const review = buildTradingLabDashboardUxPolishReviewResult(step168Input);
  const recordingGate = buildTradingLabDashboardUxPolishReviewResultRecordingGate(step168Input);
  const receipt = buildTradingLabDashboardUxPolishReviewReceipt(step168Input);
  const decisionSummary = buildTradingLabDashboardUxPolishReviewDecisionSummary(step168Input);
  const validation = validateTradingLabDashboardUxPolishReviewResult(step168Input);
  const serialized = JSON.stringify(status);

  assert.equal(status.ok, true);
  assert.equal(status.step, "Step 168: Admin trading lab dashboard UX polish review result recording gate");
  assert.equal(status.status, "admin_only_trading_lab_dashboard_ux_polish_review_result_fail_closed");
  assert.equal(status.dashboardUxPolishReviewResultModel.sourceStep, "step168");
  assert.equal(status.dashboardUxPolishReviewReceiptSchema.sourceStep, "step168");
  assert.equal(status.dashboardUxPolishReviewDecisionSummaryModel.sourceStep, "step168");
  assert.equal(status.dependency.step167Required, true);
  assert.equal(status.dependency.preflightStatus, "mock_ux_polish_ready");
  assert.equal(status.reviewResult.reviewStatus, "recorded");
  assert.equal(status.reviewResult.decision, "mock_dashboard_ux_polish_review_recorded");
  assert.equal(status.reviewResult.scope, "mock_only");
  assert.equal(status.reviewResult.redacted, true);
  assert.equal(status.receipt.redacted, true);
  assert.equal(status.receipt.nextAllowedStep, "mock_dashboard_ux_polish_core");
  assert.equal(status.validation.status, "recorded");
  assert.equal(status.validation.decision, "mock_dashboard_ux_polish_review_recorded");
  assert.equal(status.targetInventoryReviewSummary.status, "reviewed");
  assert.equal(status.duplicateVerboseReviewSummary.status, "reviewed");
  assert.equal(status.koreanLabelReviewSummary.status, "reviewed");
  assert.equal(status.readabilityReviewSummary.summaryFirstReadabilityReviewStatus, "reviewed");
  assert.equal(status.safetyReviewSummary.safetyNoticeReviewStatus, "reviewed");
  assert.equal(status.safetyReviewSummary.dangerousActionLabelsPresent, false);
  assert.equal(review.reviewResult.reviewStatus, "recorded");
  assert.equal(recordingGate.receipt.reviewStatus, "recorded");
  assert.equal(receipt.reviewStatus, "recorded");
  assert.equal(decisionSummary.decision, "mock_dashboard_ux_polish_review_recorded");
  assert.equal(validation.status, "recorded");
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
...
test("Step 168 admin trading lab dashboard UX polish review result blocks missing or unsafe Step167 dependency", () => {
  const missingValidation = validateTradingLabDashboardUxPolishReviewResult({
    dashboardUxPolishPreflightStatus: {},
    preflightResult: {},
  });
  const unsafeValidation = validateTradingLabDashboardUxPolishReviewResult({
    preflightResult: {
      uxPolishPreflightId: "unsafe_step167",
      status: "mock_ux_polish_ready",
      scope: "mock_only",
      redacted: false,
      readinessImpact: "none",
      providerCallImpact: "blocked",
    ...
    duplicateVerboseDetection: { redacted: false, deterministic: false },
    koreanLabelInventory: { redacted: false, deterministic: false, mappings: [] },
    summaryFirstReadability: { redacted: false, mockRunSummaryProminent: false, detailChainDefaultCollapsed: false },
    safetyNoticeVisibility: { redacted: false, noDbWriteNoticeVisible: false },
    dangerousActionLabelCheck: { redacted: false, dangerousActionLabelsPresent: true },
    providerCallsAllowed: true,
  });

  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("step167_ux_polish_preflight_required"));
  assert.ok(missingValidation.blockers.includes("step167_ux_polish_preflight_result_required"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("step167_ux_polish_result_must_be_redacted"));
  assert.ok(unsafeValidation.blockers.includes("ux_polish_target_inventory_must_remain_redacted_step167"));
  assert.ok(unsafeValidation.blockers.includes("duplicate_verbose_review_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("korean_label_review_must_be_redacted_deterministic"));
  assert.ok(unsafeValidation.blockers.includes("summary_first_readability_review_required"));
  assert.ok(unsafeValidation.blockers.includes("collapsible_default_review_required"));
  assert.ok(unsafeValidation.blockers.includes("safety_notice_visibility_review_required"));
  assert.ok(unsafeValidation.blockers.includes("dangerous_action_label_review_must_remain_absent"));
  assert.ok(unsafeValidation.blockers.includes("side_effects_must_remain_false"));
});

test("Step 168 admin trading lab dashboard integration preserves Step167 and Step166 mypage/account surfaces", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.dashboardUxPolishReviewResultStatus;
  const serialized = JSON.stringify(dashboard);

  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.step, "Step 168: Admin trading lab dashboard UX polish review result recording gate");
  assert.equal(dashboard.dashboardUxPolishPreflightStatus.step, "Step 167: Admin trading lab dashboard UX polish preflight");
  assert.equal(dashboard.mockDashboardCleanupCoreReviewResultStatus.step, "Step 165: Admin trading lab mock dashboard cleanup core review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupCoreStatus.step, "Step 164: Admin trading lab mock dashboard cleanup core");
  assert.equal(dashboard.mockDashboardCleanupReviewResultStatus.step, "Step 163: Admin trading lab mock dashboard cleanup review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupPreflightStatus.step, "Step 162: Admin trading lab mock dashboard cleanup preflight");
  assert.equal(dashboard.mockTradingRunSummaryCoreStatus.step, "Step 161: Admin trading lab mock trading run summary core");
  assert.equal(dashboard.dashboardUxPolishReviewResultModel.sourceStep, "step168");
  assert.equal(dashboard.dashboardUxPolishReviewReceiptSchema.sourceStep, "step168");
  assert.equal(dashboard.dashboardUxPolishReviewDecisionSummaryModel.sourceStep, "step168");
  assert.equal(status.reviewResult.reviewStatus, "recorded");
  assert.equal(status.receipt.nextAllowedStep, "mock_dashboard_ux_polish_core");
  assert.equal(status.boundaries.publicDashboardExposed, false);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
...
test("Step 169 admin trading lab dashboard UX polish core applies redacted summary-first mock-only layout without side effects", () => {
  const reviewStatus = buildAdminTradingLabDashboardUxPolishReviewResultStatus();
  const step169Input = {
    dashboardUxPolishReviewResultStatus: reviewStatus,
    reviewResult: reviewStatus.reviewResult,
    receipt: reviewStatus.receipt,
  };
  const status = buildAdminTradingLabDashboardUxPolishCoreStatus(step169Input);
  const core = buildTradingLabDashboardUxPolishCoreResult(step169Input);
  const validation = validateTradingLabDashboardUxPolishCore(step169Input);
  const summaryFirstLayout = buildTradingLabDashboardUxPolishSummaryFirstLayoutResult(step169Input);
  const detailChain = buildTradingLabDashboardUxPolishCollapsibleDetailChainResult(step169Input);
  const koreanLabels = buildTradingLabDashboardUxPolishKoreanLabelResult(step169Input);
  const safetyNotice = buildTradingLabDashboardUxPolishSafetyNoticeResult(step169Input);
  const readability = buildTradingLabDashboardUxPolishReadabilityResult(step169Input);
  const duplicateVerbose = buildTradingLabDashboardUxPolishDuplicateVerboseCleanupResult(step169Input);
  const serialized = JSON.stringify(status);

  assert.equal(status.ok, true);
  assert.equal(status.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.status, "admin_only_trading_lab_dashboard_ux_polish_core_fail_closed");
  assert.equal(status.dashboardUxPolishCoreModel.sourceStep, "step169");
  assert.equal(status.dashboardUxPolishCoreResultSchema.sourceStep, "step169");
  assert.equal(status.summaryFirstLayoutResultModel.sourceStep, "step169");
  assert.equal(status.collapsibleDetailChainResultModel.sourceStep, "step169");
  assert.equal(status.koreanLabelPolishResultModel.sourceStep, "step169");
  assert.equal(status.safetyNoticePolishResultModel.sourceStep, "step169");
  assert.equal(status.readabilityPolishResultModel.sourceStep, "step169");
  assert.equal(status.duplicateVerboseCleanupResultModel.sourceStep, "step169");
  assert.equal(status.dependency.step168Required, true);
  assert.equal(status.dependency.reviewStatus, "recorded");
  assert.equal(status.dependency.receiptNextAllowedStep, "mock_dashboard_ux_polish_core");
  assert.equal(status.coreResult.polishStatus, "mock_ux_polish_applied");
  assert.equal(status.coreResult.scope, "mock_only");
  assert.equal(status.coreResult.redacted, true);
  assert.equal(status.coreResult.deterministic, true);
  assert.equal(status.coreResult.summaryFirstLayoutStatus, "applied");
  assert.equal(status.coreResult.collapsibleDetailStatus, "applied");
  assert.equal(status.coreResult.koreanLabelStatus, "applied");
  assert.equal(status.coreResult.safetyNoticeStatus, "visible");
  assert.equal(status.coreResult.dangerousActionLabelStatus, "absent");
  assert.equal(status.coreResult.duplicateVerboseStatus, "cleaned");
  assert.equal(core.coreResult.polishStatus, "mock_ux_polish_applied");
  assert.equal(validation.status, "mock_ux_polish_applied");
  assert.equal(summaryFirstLayout.summaryCardsFirst, true);
  assert.equal(summaryFirstLayout.topOrder[0], "mock_trading_run_summary");
  assert.equal(detailChain.defaultCollapsed, true);
  assert.equal(detailChain.groupCount, 6);
  assert.equal(koreanLabels.status, "applied");
  assert.ok(koreanLabels.labelCount >= 10);
  assert.equal(safetyNotice.noProviderCallNoticeVisible, true);
  assert.equal(safetyNotice.noOrderSubmissionNoticeVisible, true);
  assert.equal(safetyNotice.noDbWriteNoticeVisible, true);
  assert.equal(safetyNotice.dangerousActionLabelsPresent, false);
  assert.equal(readability.mockRunSummaryProminent, true);
  assert.equal(duplicateVerbose.existingSectionsPreserved, true);
  assert.equal(status.providerCallsAllowed, false);
  assert.equal(status.orderSubmissionAllowed, false);
  assert.equal(status.readyForReadOnlyProviderCalls, false);
  assert.equal(status.readyForOrderSubmission, false);
  ...
  assert.equal(status.performanceRecordPersisted, false);
  assert.equal(status.tradingRunSummaryPersisted, false);
  assert.equal(status.cashPositionMutated, false);
  assert.equal(status.persistentStorageUsed, false);
  assert.equal(status.dbWriteUsed, false);
  assert.equal(status.boundaries.adminOnly, true);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
...
test("Step 169 admin trading lab dashboard UX polish core blocks missing or unsafe Step168 dependency", () => {
  const missingValidation = validateTradingLabDashboardUxPolishCore({
    dashboardUxPolishReviewResultStatus: {},
    reviewResult: {},
    receipt: {},
  });
  const unsafeValidation = validateTradingLabDashboardUxPolishCore({
    reviewResult: {
      uxPolishReviewResultId: "unsafe_step168",
      scope: "mock_only",
      reviewStatus: "recorded",
      decision: "mock_dashboard_ux_polish_review_recorded",
      redacted: false,
      readinessImpact: "none",
      providerCallImpact: "blocked",
      orderSubmissionImpact: "blocked",
    ...
    receipt: {
      redacted: false,
      nextAllowedStep: "mock_dashboard_ux_polish_core",
      readinessImpact: "none",
      providerCallImpact: "blocked",
      orderSubmissionImpact: "blocked",
      liveTradingImpact: "blocked",
    },
    targetInventoryReviewSummary: { status: "blocked" },
    duplicateVerboseReviewSummary: { status: "blocked" },
    koreanLabelReviewSummary: { status: "blocked" },
    readabilityReviewSummary: {
      summaryFirstReadabilityReviewStatus: "blocked",
      collapsibleDefaultReviewStatus: "blocked",
    },
    safetyReviewSummary: {
      safetyNoticeReviewStatus: "blocked",
      dangerousActionLabelReviewStatus: "blocked",
    },
    providerCallsAllowed: true,
  });

  assert.equal(missingValidation.status, "blocked");
  assert.ok(missingValidation.blockers.includes("step168_ux_polish_review_result_required"));
  assert.ok(missingValidation.blockers.includes("step168_ux_polish_review_payload_required"));
  assert.ok(missingValidation.blockers.includes("step168_ux_polish_review_receipt_required"));
  assert.equal(unsafeValidation.status, "blocked");
  assert.ok(unsafeValidation.blockers.includes("step168_ux_polish_review_must_be_redacted"));
  assert.ok(unsafeValidation.blockers.includes("target_inventory_review_must_be_reviewed"));
  assert.ok(unsafeValidation.blockers.includes("duplicate_verbose_review_must_be_reviewed"));
  assert.ok(unsafeValidation.blockers.includes("korean_label_review_must_be_reviewed"));
  assert.ok(unsafeValidation.blockers.includes("summary_first_review_must_be_reviewed"));
  assert.ok(unsafeValidation.blockers.includes("collapsible_default_review_must_be_reviewed"));
  assert.ok(unsafeValidation.blockers.includes("safety_notice_review_must_be_reviewed"));
  assert.ok(unsafeValidation.blockers.includes("dangerous_action_label_review_must_be_reviewed"));
  assert.ok(unsafeValidation.blockers.includes("side_effects_must_remain_false"));
});

test("Step 169 admin trading lab dashboard integration preserves Step168 chain and Step166 mypage/account surfaces", () => {
  const dashboard = buildAdminTradingLabDashboardStatus();
  const status = dashboard.dashboardUxPolishCoreStatus;
  const serialized = JSON.stringify(dashboard);

  assert.equal(dashboard.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(status.step, "Step 169: Admin trading lab dashboard UX polish core");
  assert.equal(dashboard.dashboardUxPolishReviewResultStatus.step, "Step 168: Admin trading lab dashboard UX polish review result recording gate");
  assert.equal(dashboard.dashboardUxPolishPreflightStatus.step, "Step 167: Admin trading lab dashboard UX polish preflight");
  assert.equal(dashboard.mockDashboardCleanupCoreReviewResultStatus.step, "Step 165: Admin trading lab mock dashboard cleanup core review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupCoreStatus.step, "Step 164: Admin trading lab mock dashboard cleanup core");
  assert.equal(dashboard.mockDashboardCleanupReviewResultStatus.step, "Step 163: Admin trading lab mock dashboard cleanup review result recording gate");
  assert.equal(dashboard.mockDashboardCleanupPreflightStatus.step, "Step 162: Admin trading lab mock dashboard cleanup preflight");
  assert.equal(dashboard.mockTradingRunSummaryCoreStatus.step, "Step 161: Admin trading lab mock trading run summary core");
  assert.equal(dashboard.dashboardUxPolishCoreModel.sourceStep, "step169");
  assert.equal(dashboard.dashboardUxPolishCoreResultSchema.sourceStep, "step169");
  assert.equal(status.coreResult.polishStatus, "mock_ux_polish_applied");
  assert.equal(status.summaryFirstLayout.summaryCardsFirst, true);
  assert.equal(status.collapsibleDetailChain.defaultCollapsed, true);
  assert.equal(status.koreanLabelPolish.status, "applied");
  assert.equal(status.safetyNoticePolish.dangerousActionLabelsPresent, false);
  assert.equal(status.boundaries.publicDashboardExposed, false);
  assert.equal(status.boundaries.myPageDashboardExposed, false);
  assert.equal(status.boundaries.homepageDashboardExposed, false);
  assert.equal(status.boundaries.myPageRouteTouched, false);
