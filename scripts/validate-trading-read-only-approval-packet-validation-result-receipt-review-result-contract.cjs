...
function validateReviewResultBoundary(errors, boundary) {
  ...
  if (boundary.futureValidationResultReceiptPath !== FUTURE_VALIDATION_RESULT_RECEIPT_PATH) {
    errors.push(
      makeError(
        ...
        "futureReadOnlyApprovalValidationResultReceiptReviewResultBoundary.futureValidationResultReceiptPath",
    ...
    if (boundary[flag] !== false) {
      errors.push(
        makeError(
          ...
          `futureReadOnlyApprovalValidationResultReceiptReviewResultBoundary.${flag}`,
          `${flag} must be false`,
        ),
      );
    }
  ...
  pushMissingArrayErrors(
    ...
    "futureReadOnlyApprovalValidationResultReceiptReviewResultBoundary.requiredReviewResultFields",
  ...
  pushMissingArrayErrors(
    ...
    "futureReadOnlyApprovalValidationResultReceiptReviewResultBoundary.requiredReviewResultAssertions",
  ...
  pushMissingArrayErrors(
    ...
    "futureReadOnlyApprovalValidationResultReceiptReviewResultBoundary.forbiddenReviewResultContent",
    "missing_forbidden_review_result_content",
  );
}

function validateTradingReadOnlyApprovalPacketValidationResultReceiptReviewResultContract(contract) {
  const errors = [];
  ...
  validateReviewResultBoundary(errors, contract.futureReadOnlyApprovalValidationResultReceiptReviewResultBoundary);
...
function main() {
  ...
  if (args.help) {
    console.log(
      "Usage: node scripts/validate-trading-read-only-approval-packet-validation-result-receipt-review-result-contract.cjs --contract <path>",
    );
    return;
  }
  if (args.unknown) {
  ...
  const result = validateTradingReadOnlyApprovalPacketValidationResultReceiptReviewResultContract(contract);
