...
test("keeps read-only approval import review-result recording-result review-result recording-result review-result recording-result review-result recording-result review-result supply gate locked", () => {
  exerciseGate({
    tmpPrefix: "finple-read-only-approval-review-result-review-result-recording-result-review-result-recording-result-review-result-supply-gate",
    script:
      "generate-trading-read-only-approval-import-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-supply-gate-contract.cjs",
    contract:
