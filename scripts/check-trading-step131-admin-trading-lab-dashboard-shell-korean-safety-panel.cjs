...
const REQUIRED_FILES = [
  ...
  "scripts/check-trading-step131-admin-trading-lab-dashboard-shell-korean-safety-panel.test.cjs",
];
...
const REQUIRED_SNIPPETS = [
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_STRATEGY_CONFIG_SCHEMA"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_DAILY_RETURN_SERIES_SCHEMA"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_CUMULATIVE_PERFORMANCE_SCHEMA"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_POSITION_SNAPSHOT_SCHEMA"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_ORDER_CANDIDATE_SUMMARY_SCHEMA"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_AUDIT_LOG_SUMMARY_SCHEMA"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "buildAdminTradingLabDashboardStatus"],
  ...
  ["server/src/services/tradingAdminLabDashboardShell.js", "tokenIssuanceAttempted: false"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "quoteRequestAttempted: false"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "networkCallAttempted: false"],
  ...
  ["src/components/TradingReadinessPanel.jsx", "관리자 Trading Lab"],
  ["src/components/TradingReadinessPanel.jsx", "모의 운용 대시보드"],
  ["src/components/TradingReadinessPanel.jsx", "거래 안전상태"],
  ["src/components/TradingReadinessPanel.jsx", "내부 증권 API 호출"],
  ["src/components/TradingReadinessPanel.jsx", "실제 주문 제출"],
  ["src/components/TradingReadinessPanel.jsx", "읽기 전용 시세 조회"],
  ["src/components/TradingReadinessPanel.jsx", "tradingLabDashboardStatus"],
  ["src/App.css", "tradingLabDashboard"],
  ["package.json", "check:trading-step131-admin-trading-lab-dashboard-shell-korean-safety-panel"],
];
...
function main() {
  ...
  const touchedScenarioFiles = forbiddenScenarioFiles.filter((filePath) => fs.existsSync(filePath) && readText(filePath).includes("Step 131"));
  ...
  console.log("[check-trading-step131-admin-trading-lab-dashboard-shell-korean-safety-panel] ok");
}
