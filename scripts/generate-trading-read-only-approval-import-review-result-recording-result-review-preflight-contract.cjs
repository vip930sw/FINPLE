...
const CONTRACT_VERSION =
  "trading-lab-step116-read-only-approval-import-review-result-recording-result-review-preflight-v0.1";
...
const REQUIRED_REVIEW_PREFLIGHT_GATES = [
  ...
  "owner_redacted_approval_import_review_recording_result_review_required_later",
...
function buildContract() {
  ...
  const checks = {
    ...
    recordingResultContractReady:
      ...
      recordingResultContract.readiness?.ownerRedactedApprovalImportReviewResultRecordingResultRecordedNow === false &&
      ...
      recordingResultContract.readiness?.currentStepRecordsHashInputs === false &&
      recordingResultContract.readiness?.approvalPacketImportedNow === false &&
    ...
    architectureDocMentionsReviewPreflight:
      architectureDoc.includes("Trading Read-Only Approval Import Review Result Recording Result Review Preflight") &&
      architectureDoc.includes("read_only_approval_import_review_result_recording_result_review_preflight"),
    noRuntimeArtifacts: forbiddenArtifacts.length === 0,
    ownerRedactedApprovalImportReviewResultRecordingResultReviewAcceptedNow: false,
    ownerRedactedApprovalImportReviewResultRecordingResultReviewReadNow: false,
    ownerRedactedApprovalImportReviewResultRecordingResultReviewRecordedNow: false,
  ...
  const readyForReadOnlyApprovalImportReviewResultRecordingResultReviewPreflight =
  ...
  return stableJson({
    ...
    step: "Step 116-5Q-P",
    scope: "read_only_approval_import_review_result_recording_result_review_preflight",
    sourceFiles: {
    ...
    importReviewResultRecordingResultReviewPreflight: {
      ownerRedactedApprovalImportReviewResultRecordingResultReviewRequiredLater: true,
      ...
      nextAllowedAction:
        "after the owner supplies a redacted approval import review recording-result review outside repo commits, open a separate review-result supply gate without importing approval evidence",
    ...
    readiness: {
      status: readyForReadOnlyApprovalImportReviewResultRecordingResultReviewPreflight
        ? "read_only_approval_import_review_result_recording_result_review_preflight_ready_import_still_blocked_pending_owner_review"
        : "blocked_before_read_only_approval_import_review_result_recording_result_review_preflight",
      readyForReadOnlyApprovalImportReviewResultRecordingResultReviewPreflight,
      ...
      blockers: [
        ...
        ...missingReviewPreflightGates.map((gate) => `missing_review_preflight_gate_${gate}`),
        ...missingForbiddenReviewPreflightContent.map(
          (content) => `missing_forbidden_review_preflight_content_${content}`,
        ),
        ...(checks.architectureDocMentionsReviewPreflight
          ? []
          : ["architecture_doc_missing_read_only_approval_import_review_result_recording_result_review_preflight"]),
...
function main() {
  ...
  if (process.argv.includes("--check")) {
    ...
    console.log("[generate-trading-read-only-approval-import-review-result-recording-result-review-preflight-contract] ok");
    console.log(
      `[generate-trading-read-only-approval-import-review-result-recording-result-review-preflight-contract] contract=${CONTRACT_PATH}`,
    );
    return;
  }
  ...
  console.log(
    "[generate-trading-read-only-approval-import-review-result-recording-result-review-preflight-contract] wrote contract",
  );
  console.log(
    `[generate-trading-read-only-approval-import-review-result-recording-result-review-preflight-contract] readyForReadOnlyApprovalImportReviewResultRecordingResultReviewPreflight=${parsed.readiness.readyForReadOnlyApprovalImportReviewResultRecordingResultReviewPreflight}`,
  );
}
