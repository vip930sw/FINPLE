...
runContract({
  step: "Step 116-9M",
  scope: "live_guarded_forbidden_item_unlock_review_result_recording_result_review_result_recording_preflight",
  ...
  logName:
    "generate-trading-forbidden-item-unlock-review-result-recording-result-review-result-recording-preflight-contract",
  sources: [
    {
