...
test("keeps read-only approval import review-result recording-result review-result recording-result review-result recording-result review-result recording-result review-result recording-result review result recording preflight locked", () => {
  exerciseGate({
    tmpPrefix: "finple-read-only-approval-review-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-recording-preflight",
    script:
      "generate-trading-read-only-approval-import-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-recording-preflight-contract.cjs",
    contract:
    ...
    stdoutPattern: "recording-result-review-result-recording-result-review-result-recording-preflight-contract",
  });
});
