...
const REQUIRED_FILES = [
  ...
  "scripts/check-trading-step150-admin-trading-lab-mock-portfolio-ledger-update-review-result-recording-gate.test.cjs",
  "scripts/check-trading-step149-admin-trading-lab-mock-portfolio-ledger-update-preflight.cjs",
];

const REQUIRED_SNIPPETS = [
  ["server/src/services/tradingAdminLabDashboardShell.js", "STEP150_ADMIN_TRADING_LAB_MOCK_PORTFOLIO_LEDGER_UPDATE_REVIEW_RESULT_FLAGS"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_MOCK_PORTFOLIO_LEDGER_UPDATE_REVIEW_RESULT_MODEL"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_MOCK_LEDGER_UPDATE_REVIEW_RECEIPT_SCHEMA"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_MOCK_LEDGER_UPDATE_REVIEW_DECISION_SUMMARY_MODEL"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "TRADING_LAB_MOCK_LEDGER_UPDATE_IMPACT_REVIEW_SUMMARY_MODEL"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "validateTradingLabMockPortfolioLedgerUpdateReviewResult"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "buildTradingLabMockPortfolioLedgerUpdateReviewResult"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "buildTradingLabMockPortfolioLedgerUpdateReviewResultRecordingGate"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "buildTradingLabMockLedgerUpdateImpactReviewSummary"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "buildTradingLabMockLedgerUpdateReviewDecisionSummary"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "buildAdminTradingLabMockPortfolioLedgerUpdateReviewResultStatus"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "admin_only_trading_lab_mock_portfolio_ledger_update_review_result_fail_closed"],
  ["server/src/services/tradingAdminLabDashboardShell.js", "mock_portfolio_ledger_update_core_preflight"],
  ...
  ["server/src/routes/adminTradingReadinessRoutes.js", "buildAdminTradingLabMockPortfolioLedgerUpdateReviewResultStatus"],
  ["server/src/routes/adminTradingReadinessRoutes.js", 'router.get("/trading-lab-mock-portfolio-ledger-update-review-result"'],
  ["server/src/routes/adminTradingReadinessRoutes.js", "requireAdminAccess"],
  ["server/src/routes/adminTradingReadinessRoutes.test.js", "trading-lab-mock-portfolio-ledger-update-review-result"],
  ["src/components/portfolio/services/serverPortfolioService.js", "fetchAdminTradingLabMockPortfolioLedgerUpdateReviewResultStatus"],
  ["src/components/portfolio/services/serverPortfolioService.js", "\"/admin/trading-readiness/trading-lab-mock-portfolio-ledger-update-review-result\""],
  ["src/components/TradingReadinessPanel.jsx", "tradingLabMockPortfolioLedgerUpdateReviewResultStatus"],
  ["src/components/TradingReadinessPanel.jsx", "tradingLabMockLedgerUpdateReviewCards"],
  ["src/components/TradingReadinessPanel.jsx", "tradingLabMockLedgerUpdateReviewList"],
  ["src/components/TradingReadinessPanel.jsx", "Mock portfolio ledger update review result"],
  ["src/components/TradingReadinessPanel.jsx", "It does not change real account ledgers, DB state, cash, positions, fills, executions, orders, KIS payloads, or live/provider/order gates."],
  ["src/App.css", ".tradingLabMockLedgerUpdateReviewCards"],
  ["src/App.css", ".tradingLabMockLedgerUpdateReviewList"],
  ["package.json", "check:trading-step150-admin-trading-lab-mock-portfolio-ledger-update-review-result-recording-gate"],
];
...
function main() {
  ...
  if (!/router\.get\("\/trading-lab-mock-portfolio-ledger-update-review-result"[\s\S]*requireAdminAccess[\s\S]*buildAdminTradingLabMockPortfolioLedgerUpdateReviewResultStatus/.test(routeText)) {
    fail("mock portfolio ledger update review result endpoint must stay admin-only and read-only");
  }
  ...
  const publicExposureTerms = [
    "tradingLabMockPortfolioLedgerUpdateReviewResultStatus",
    "trading-lab-mock-portfolio-ledger-update-review-result",
  ...
  if (accountExposure.length > 0) fail(`mock portfolio ledger update review result must not be exposed on /mypage: ${accountExposure.join(", ")}`);
  const appExposure = publicExposureTerms.filter((term) => appText.includes(term));
  if (appExposure.length > 0) fail(`mock portfolio ledger update review result must not be exposed on homepage or public router: ${appExposure.join(", ")}`);
  ...
  const touchedScenarioFiles = scenarioFiles.filter((filePath) => fs.existsSync(filePath) && readText(filePath).includes("Step 150"));
  if (touchedScenarioFiles.length > 0) fail(`scenario runtime files must remain untouched: ${touchedScenarioFiles.join(", ")}`);

  console.log("[check-trading-step150-admin-trading-lab-mock-portfolio-ledger-update-review-result-recording-gate] ok");
}
