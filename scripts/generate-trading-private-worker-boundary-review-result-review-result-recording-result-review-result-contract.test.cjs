...
test("keeps private worker boundary review-result recording-result review result locked", () => {
  exerciseGate({
    tmpPrefix: "finple-boundary-review-result-recording-result-review-result",
    script:
      "generate-trading-private-worker-boundary-review-result-review-result-recording-result-review-result-contract.cjs",
    contract:
    ...
    previousKey: "liveGuardedPrivateWorkerImplementationBoundaryReviewResultRecordingResultReviewResultSupplyGate",
    requiredContracts: [
