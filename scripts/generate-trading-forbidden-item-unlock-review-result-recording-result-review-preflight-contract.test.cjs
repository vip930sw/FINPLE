...
test("keeps forbidden item unlock review-result recording-result review preflight fail-closed", () => {
  exerciseTaxonomy({
    tmpPrefix: "finple-forbidden-item-unlock-review-result-recording-result-review-preflight",
    script: "generate-trading-forbidden-item-unlock-review-result-recording-result-review-preflight-contract.cjs",
    contract: "trading_lab_step116_forbidden_item_unlock_review_result_recording_result_review_preflight_contract.json",
    readyField: "readyForLiveGuardedForbiddenItemUnlockReviewResultRecordingResultReviewPreflight",
    previousContract: "trading_lab_step116_forbidden_item_unlock_review_result_recording_result_contract.json",
    previousReadyField: "readyForLiveGuardedForbiddenItemUnlockReviewResultRecordingResult",
    previousKey: "forbiddenItemUnlockReviewResultRecordingResult",
    requiredContracts: [
    ...
    stdoutPattern: "forbidden-item-unlock-review-result-recording-result-review-preflight-contract",
  });
});
