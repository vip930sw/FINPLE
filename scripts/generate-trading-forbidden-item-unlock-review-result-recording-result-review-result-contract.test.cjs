...
test("keeps forbidden item unlock review-result recording-result review result fail-closed", () => {
  exerciseTaxonomy({
    tmpPrefix: "finple-forbidden-item-unlock-review-result-recording-result-review-result",
    script: "generate-trading-forbidden-item-unlock-review-result-recording-result-review-result-contract.cjs",
    contract: "trading_lab_step116_forbidden_item_unlock_review_result_recording_result_review_result_contract.json",
    ...
    previousReadyField: "readyForLiveGuardedForbiddenItemUnlockReviewResultRecordingResultReviewResultSupplyGate",
    previousKey: "forbiddenItemUnlockReviewResultRecordingResultReviewResultSupplyGate",
    requiredContracts: [
    ...
    stdoutPattern: "forbidden-item-unlock-review-result-recording-result-review-result-contract",
  });
});
