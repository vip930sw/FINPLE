...
test("keeps forbidden item unlock review-result recording-result review-result supply gate fail-closed", () => {
  exerciseTaxonomy({
    tmpPrefix: "finple-forbidden-item-unlock-review-result-recording-result-review-result-supply-gate",
    script: "generate-trading-forbidden-item-unlock-review-result-recording-result-review-result-supply-gate-contract.cjs",
    contract:
    ...
    previousReadyField: "readyForLiveGuardedForbiddenItemUnlockReviewResultRecordingResultReviewPreflight",
    previousKey: "forbiddenItemUnlockReviewResultRecordingResultReviewPreflight",
    requiredContracts: [
    ...
    stdoutPattern: "forbidden-item-unlock-review-result-recording-result-review-result-supply-gate-contract",
  });
});
