...
test("keeps private worker boundary review-result recording-result review preflight locked", () => {
  exerciseGate({
    tmpPrefix: "finple-boundary-review-result-recording-result-review-preflight",
    script:
      "generate-trading-private-worker-boundary-review-result-review-result-recording-result-review-preflight-contract.cjs",
    contract:
    ...
    previousKey: "liveGuardedPrivateWorkerImplementationBoundaryReviewResultRecordingResult",
    requiredContracts: [
      "trading_lab_step116_private_worker_boundary_review_result_review_result_recording_result_contract.json",
    ],
