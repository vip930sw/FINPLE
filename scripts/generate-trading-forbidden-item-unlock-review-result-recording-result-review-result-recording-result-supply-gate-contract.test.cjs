...
test("keeps forbidden item unlock review-result recording-result review-result recording-result supply gate fail-closed", () => {
  exerciseTaxonomy({
    tmpPrefix: "finple-forbidden-item-unlock-review-result-recording-result-review-result-recording-result-supply-gate",
    script:
      "generate-trading-forbidden-item-unlock-review-result-recording-result-review-result-recording-result-supply-gate-contract.cjs",
    contract:
    ...
    previousReadyField: "readyForLiveGuardedForbiddenItemUnlockReviewResultRecordingResultReviewResultRecordingPreflight",
    previousKey: "forbiddenItemUnlockReviewResultRecordingResultReviewResultRecordingPreflight",
    requiredContracts: [
    ...
    stdoutPattern:
      "forbidden-item-unlock-review-result-recording-result-review-result-recording-result-supply-gate-contract",
  });
});
