...
const CONTRACT_VERSION =
  "trading-lab-step116-read-only-approval-import-review-result-recording-result-review-result-recording-preflight-v0.1";
...
function buildContract() {
  ...
  const missingRecordingPreflightGates = missingValues(
    recordingPreflightGates,
    REQUIRED_RECORDING_PREFLIGHT_GATES,
  );
  ...
  const checks = {
    ...
    reviewResultContractReady:
      ...
      reviewResultContract.readiness?.currentStepReadsRecordingResult === false &&
    ...
    architectureDocMentionsRecordingPreflight:
      architectureDoc.includes(
        "Trading Read-Only Approval Import Review Result Recording Result Review Result Recording Preflight",
      ) &&
      architectureDoc.includes(
        "read_only_approval_import_review_result_recording_result_review_result_recording_preflight",
      ),
    noRuntimeArtifacts: forbiddenArtifacts.length === 0,
    ownerRedactedApprovalImportReviewResultRecordingResultReviewResultAcceptedNow: false,
  ...
  const readyForReadOnlyApprovalImportReviewResultRecordingResultReviewResultRecordingPreflight =
  ...
  return stableJson({
    ...
    step: "Step 116-5Q-S",
    scope: "read_only_approval_import_review_result_recording_result_review_result_recording_preflight",
    sourceFiles: {
    ...
    importReviewResultRecordingResultReviewResultRecordingPreflight: {
      ...
      nextAllowedAction:
        "after the owner supplies a redacted approval import review recording-result review result outside repo commits, record a separate hash-only review-result recording result boundary",
      recordingPreflightGates,
      forbiddenRecordingPreflightContent,
      futureRecordingRules: [
        "owner_supplied_redacted_import_review_recording_result_review_result_only",
    ...
    readiness: {
      status: readyForReadOnlyApprovalImportReviewResultRecordingResultReviewResultRecordingPreflight
        ? "read_only_approval_import_review_result_recording_result_review_result_recording_preflight_ready_import_still_blocked_pending_owner_review_result"
        : "blocked_before_read_only_approval_import_review_result_recording_result_review_result_recording_preflight",
      readyForReadOnlyApprovalImportReviewResultRecordingResultReviewResultRecordingPreflight,
      ...
      blockers: [
        ...
        ...(checks.architectureDocMentionsRecordingPreflight
          ? []
          : [
              "architecture_doc_missing_read_only_approval_import_review_result_recording_result_review_result_recording_preflight",
            ]),
...
function main() {
  ...
  if (process.argv.includes("--check")) {
    ...
    console.log("[generate-trading-read-only-approval-import-review-result-recording-result-review-result-recording-preflight-contract] ok");
    console.log(
      `[generate-trading-read-only-approval-import-review-result-recording-result-review-result-recording-preflight-contract] contract=${CONTRACT_PATH}`,
    );
    return;
  }
  ...
  console.log("[generate-trading-read-only-approval-import-review-result-recording-result-review-result-recording-preflight-contract] wrote contract");
  console.log(
    `[generate-trading-read-only-approval-import-review-result-recording-result-review-result-recording-preflight-contract] readyForReadOnlyApprovalImportReviewResultRecordingResultReviewResultRecordingPreflight=${parsed.readiness.readyForReadOnlyApprovalImportReviewResultRecordingResultReviewResultRecordingPreflight}`,
  );
}
