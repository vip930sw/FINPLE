...
test("keeps read-only approval import review-result recording-result review result recording result review result recording result review result recording result review result recording result br preflight locked", () => {
  exerciseGate({
    tmpPrefix: "finple-read-only-approval-br-preflight",
    script:
      "generate-trading-read-only-approval-import-review-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-br-review-preflight-contract.cjs",
    contract:
    ...
    stdoutPattern:
      "read-only-approval-import-review-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-review-result-recording-result-br-review-preflight-contract",
  });
});
