...
function sourceReady(source) {
  ...
  return {
    ...
    ready:
      ...
      lockedFlagsAreFalse(readiness) &&
      readiness.readyForFutureReadOnlyApprovalImportImplementationReview !== true &&
      readiness.importImplementationAllowedNow !== true &&
      readiness.approvalPacketImportedNow !== true,
...
function buildContract(config) {
  ...
  return stableJson({
    ...
    currentState: {
      ...
      currentStepImplementsApprovalImport: false,
      currentStepImportsApprovalEvidence: false,
    ...
    boundary: {
      ...
      currentStepMayImplementApprovalImport: false,
      currentStepMayImportApprovalEvidence: false,
    ...
    readiness: {
      ...
      dbMigrationAllowed: false,
      liveTradingAllowed: false,
      pendingExternalInputs: config.pendingExternalInputs,
      blockers,
    },
  });
}
