...
test("keeps forbidden item unlock review-result recording-result review-result recording preflight fail-closed", () => {
  exerciseTaxonomy({
    tmpPrefix: "finple-forbidden-item-unlock-review-result-recording-result-review-result-recording-preflight",
    script:
      "generate-trading-forbidden-item-unlock-review-result-recording-result-review-result-recording-preflight-contract.cjs",
    contract:
    ...
    previousReadyField: "readyForLiveGuardedForbiddenItemUnlockReviewResultRecordingResultReviewResult",
    ...
    stdoutPattern: "forbidden-item-unlock-review-result-recording-result-review-result-recording-preflight-contract",
  });
});
