...
runContract({
  step: "Step 116-9I",
  scope: "live_guarded_forbidden_item_unlock_review_result_recording_result",
  ...
  logName: "generate-trading-forbidden-item-unlock-review-result-recording-result-contract",
  sources: [
    {
      key: "forbiddenItemUnlockReviewResultRecordingResultSupplyGate",
      path: path.join(
        "data",
        "processed",
