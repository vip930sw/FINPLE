...
export async function fetchAdminTradingLabDashboardUxPolishReviewResultStatus() {
...
export async function fetchAdminTradingLabDbBackedMockTradingHistoryPreflightStatus() {
  return requestJson("/admin/trading-readiness/trading-lab-db-backed-mock-trading-history-preflight", {}, { includeAdminToken: true });
}

export async function fetchAdminTradingLabDbBackedMockTradingHistoryReviewResultStatus() {
...
export async function fetchAdminTradingLabDbBackedMockTradingHistoryMigrationReviewResultStatus() {
  return requestJson("/admin/trading-readiness/trading-lab-db-backed-mock-trading-history-migration-review-result", {}, { includeAdminToken: true });
}
