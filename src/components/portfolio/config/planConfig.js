...
export const FINPLE_PLAN_CONFIGS = {
  free: {
    ...
    upgradeDescription: "Personal 플랜부터 포트폴리오 저장 수, 자산 수, 서버 저장, PDF 리포트, 포트폴리오 AI 분석 기능을 확장할 수 있습니다.",
    items: [
      "포트폴리오 3개 저장",
      "포트폴리오당 자산 5개",
      "Step 1~3 기본분석 제공",
      "Step 4~6 고급분석은 Personal 제공",
      "Step 7 브라우저 저장",
      "PDF 리포트 제한",
    ],
    features: {
  ...
  personal: {
    ...
    upgradeDescription: "포트폴리오 30개, 포트폴리오당 자산 30개, 서버 저장, PDF 리포트, 포트폴리오 AI 분석 기능을 사용할 수 있습니다.",
    items: [
      "포트폴리오 30개 저장",
      "포트폴리오당 자산 30개",
      "Step 1~6 전체분석 제공",
