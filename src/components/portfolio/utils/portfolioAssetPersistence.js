...
export function normalizePersistedMetricFields(asset = {}) {
  ...
  return {
    ...
    metadataVerificationStatus: asset.metadataVerificationStatus || "",
    metadataVerificationSource: asset.metadataVerificationSource || "",
    metadataVerifiedBy: asset.metadataVerifiedBy || "",
    metadataVerifiedAt: asset.metadataVerifiedAt || "",
    metadataVerificationReason: asset.metadataVerificationReason || "",
    exposureScope: asset.exposureScope || "",
    diversificationTier: asset.diversificationTier || "",
    leverageRiskTier: asset.leverageRiskTier || "",
    longTermSuitability: asset.longTermSuitability || "",
    portfolioWarningSeverity: asset.portfolioWarningSeverity || "",
    confirmationMode: asset.confirmationMode || "",
    leverageWarningLabelKo: asset.leverageWarningLabelKo || "",
    referenceSourceUrl: asset.referenceSourceUrl || "",
    leverageMetadataRegistryActive: asset.leverageMetadataRegistryActive || "",
    leverageMetadataRegistryApplied: asset.leverageMetadataRegistryApplied || "",
    leverageMetadataRegistryValues: asset.leverageMetadataRegistryValues || "",
    leverageMetadataRegistryFingerprint: asset.leverageMetadataRegistryFingerprint || "",
