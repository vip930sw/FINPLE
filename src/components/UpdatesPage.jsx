const UPDATE_ITEMS = [
  {
    version: "Beta v0.3.0",
    date: "2026.05.29",
    category: "데이터 확장 / UX 정리",
    title: "검증 후보 5,641개 기반 자산 파인더·통합 시뮬레이터 정리",
    impact: "미국·한국 ETF와 개별주 후보 데이터를 확장하고, 가격지표 검증 후보만 화면과 시뮬레이터에 노출하도록 정리했습니다.",
    details: [
      "전체 6,000개 후보군 중 CAGR, BETA, MDD 가격지표가 검증된 5,641개 후보를 자산 파인더와 시뮬레이터 후보군으로 사용합니다.",
      "미국 가격지표 app-ready 2,973개와 한국 가격지표 app-ready 2,668개를 연결했습니다.",
      "미국 배당 overlay와 한국 ETF·개별주 배당 overlay를 보강해 배당률 표시 범위를 확장했습니다.",
      "미국/한국 시뮬레이터 메뉴를 하나의 포트폴리오 시뮬레이터로 통합하고, 자산 스크리너 명칭을 자산 파인더 중심으로 정리했습니다.",
    ],
  },
  {
    version: "Beta v0.2.0",
  ...
  },
  {
    ...
    details: [
      "시작 메뉴를 투자 MBTI, 포트폴리오 시뮬레이터, 자산 파인더 중심으로 재배치했습니다.",
  ...
  },
  {
    ...
    details: [
      "포트폴리오 시뮬레이터, 자산 파인더, 투자 MBTI 흐름을 연결했습니다.",
