  ...
  return renderShell(
    <main className="page">
      ...
      <section id="pricing" className="section pricingPreviewSection">
        ...
        <div className="priceGrid"><PriceCard name="Free" price="0원" items={["기본 시뮬레이션", "브라우저 저장", "포트폴리오 AI 분석 제한"]} onConfirm={() => navigateToPage("pricing")} /><PriceCard name="Personal" price="월 9,900원" featured items={["서버 저장", "PDF 리포트", "포트폴리오 AI 분석 20회/일"]} onConfirm={() => navigateToPage("pricing")} /><PriceCard name="Pro" price="준비 중" items={["고급 백테스트", "리밸런싱", "포트폴리오 AI 분석 한도 확장"]} onConfirm={() => navigateToPage("pricing")} /></div>
      </section>
    </main>,
    {
      subNav: (
...
function SiteFooter({ onNavigate }) {
  ...
  return (
    <footer className="footer siteFooter">
      ...
      <div className="siteFooterBusinessInfo" data-site-business-info>
